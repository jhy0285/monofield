...
export interface AgentCliLogOptions {
  ...
  homeDir: string;
  /** MonoField data dir (MONOFIELD_DATA_DIR); fallback location of the local agent home. */
  dataDir?: string | null;
  /**
...
/**
 * Collect the native on-disk logs of the coding-agent CLIs MonoField drives:
