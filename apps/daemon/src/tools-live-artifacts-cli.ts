...
const LIVE_ARTIFACTS_USAGE = `Usage:
  monofield tools live-artifacts create --input artifact.json
  monofield tools live-artifacts list [--format compact]
  monofield tools live-artifacts refresh --artifact-id <id>
  monofield tools live-artifacts update --artifact-id <id> --input artifact.json
...
Agent runtime invocation:
  "$MONOFIELD_NODE_BIN" "$MONOFIELD_BIN" tools live-artifacts list --format compact
`;
