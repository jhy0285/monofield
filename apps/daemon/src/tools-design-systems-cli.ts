...
const DESIGN_SYSTEMS_USAGE = `Usage:
  monofield tools design-systems read --path <manifest-declared-path> [--design-system <id>]
...
Agent runtime invocation:
  "$MONOFIELD_NODE_BIN" "$MONOFIELD_BIN" tools design-systems read --path preview/colors.html
`;
