...
const DE_SKILL_COPY: Record<string, LocalizedSkillCopy> = {
  ...
  'agent-browser': {
    examplePrompt:
      'Verifizieren Sie die lokale MonoField-Vorschau mit agent-browser: starten oder verbinden Sie CDP Chrome, öffnen Sie http://127.0.0.1:17573/, melden Sie Titel, URL, sichtbare Texte und speichern Sie einen Screenshot.',
    description:
      'Browser-Automation für lokale MonoField-Preview-Validierung. Verbindet sich mit einem geprüften CDP-Chrome-Endpunkt, liest gerenderten Seitenzustand, kann bei Bedarf klicken/tippen und speichert einen Screenshot.',
  },
  'blog-post': {
    examplePrompt:
  ...
  'open-design-landing': {
    examplePrompt:
      'Entwerfen Sie eine MonoField-Marketing-Landingpage im Atelier-Zero- / Monocle-Stil — warme Papierleinwand, surreale Plaster-und-Architektur-Collage, übergroße gemischte Italic-Serif-Display-Type, römische Ziffern als Sektionsmarker und ein einziger Korallenakzent.',
  },
  'open-design-landing-deck': {
    examplePrompt:
      'Erstellen Sie ein MonoField-Pitch-Deck im Atelier-Zero-Stil — Cover mit Hero-Plate, römische Sektions-Trenner, Stats-Slide, Kundenzitat, CTA und Mega-Italic-Serif-End-Card. Horizontal-Swipe-Pagination wie ein Print-Magazin.',
    description:
      'Erstellt ein Single-File-Slide-Deck im Atelier-Zero-Stil (warmes Papier, italic-serif Akzent-Spans, korallenfarbene Schluss-Dots, surreale Collage-Platten). Horizontale Magazin-Pagination mit Pfeiltasten- und Leertaste-Navigation, Live-HUD mit Slide-Zähler und Fortschrittsbalken; teilt sich Stylesheet und 16-Slot-Bildbibliothek mit dem zugehörigen Landingpage-Skill.',
  },
  'email-marketing': {
    examplePrompt:
