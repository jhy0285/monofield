...
export interface Dict {
  ...
  'settings.databaseTitle': string;
  'settings.databaseSubtitle': string;
  'settings.databaseNavHint': string;
  'settings.databaseUnavailable': string;
  'settings.databaseSecurityHint': string;
  'settings.databaseDevelopmentTitle': string;
  'settings.databaseDevelopmentHint': string;
  'settings.databaseUseExample': string;
  'settings.databaseCurrentCapability': string;
  'settings.databaseWriteRoadmap': string;
  'settings.databaseAccessPolicySaved': string;
  'settings.databaseEnvironment': string;
  'settings.databaseEnvironmentDevelopment': string;
  'settings.databaseEnvironmentTest': string;
  'settings.databaseEnvironmentProduction': string;
  'settings.databaseWritePolicy': string;
  'settings.databaseWriteDisabled': string;
  'settings.databaseWriteApproveEach': string;
  'settings.databaseWriteAlways': string;
  'settings.databaseReadApproval': string;
  'settings.databaseReadApprovalPrompt': string;
  'settings.databaseReadApprovalAlways': string;
  'settings.databaseReadApprovalSaved': string;
  'settings.databaseName': string;
  'settings.databaseNamePlaceholder': string;
  'settings.databaseHost': string;
  'settings.databasePort': string;
  'settings.databaseDatabase': string;
  'settings.databaseUsername': string;
  'settings.databasePassword': string;
  'settings.databaseRequired': string;
  'settings.databaseTesting': string;
  'settings.databaseSaving': string;
  'settings.databaseTestSucceeded': string;
  'settings.databaseSaved': string;
  'settings.databaseLoadFailed': string;
  'settings.databaseConnectionFailed': string;
  'settings.databaseTest': string;
  'settings.databaseSave': string;
  'settings.databaseRemove': string;
  'settings.dictionaryLibraryTitle': string;
  'settings.dictionaryLibrarySubtitle': string;
  'settings.dictionaryLibraryNavHint': string;
  'dictionaryLibrary.add': string;
  'dictionaryLibrary.name': string;
  'dictionaryLibrary.namePlaceholder': string;
  'dictionaryLibrary.empty': string;
  'dictionaryLibrary.versions': string;
  'dictionaryLibrary.uploadVersion': string;
  'dictionaryLibrary.rename': string;
  'dictionaryLibrary.delete': string;
  'dictionaryLibrary.deleteConfirm': string;
  'dictionaryLibrary.loading': string;
  'dictionaryLibrary.saved': string;
  'dictionaryLibrary.uploadFailed': string;
  'dictionaryLibrary.previewEmpty': string;
  ...
  'settings.appearanceThemeTitle': string;
  'settings.appearanceThemeHint': string;
  'settings.themeSystem': string;
  'settings.themeLight': string;
  'settings.themeDark': string;
  'settings.accentTitle': string;
  'settings.accentHint': string;
  'settings.accentDefault': string;
  'settings.accentPreset': string;
  'settings.accentCustom': string;
  'settings.accentHexLabel': string;
  'settings.accentInvalid': string;
  'settings.appearancePreview': string;
  'settings.appearancePreviewButton': string;
  'settings.appearancePreviewSelected': string;
  'settings.appearancePreviewFocus': string;
  ...
  'settings.aboutDescriptor': string;
  'settings.aboutTrustLine': string;
  'settings.openSourceNoticesTitle': string;
  'settings.openSourceNoticesBody': string;
  'settings.openSourceNoticesUpstream': string;
  'settings.openSourceNoticesDistribution': string;
  ...
  'notify.questionTitle': string;
  'notify.questionBody': string;
  ...
  'homeHero.chip.screenSpec': string;
  'homeHero.chip.interfaceSpec': string;
  ...
  'homeHero.chip.screenSpecDesc': string;
  'homeHero.chip.interfaceSpecDesc': string;
  ...
  'homeHero.chip.screenSpecNext': string;
  'homeHero.chip.interfaceSpecNext': string;
  ...
  'homeOpenWork.kicker': string;
  'homeOpenWork.title': string;
  'homeOpenWork.body': string;
  'homeOpenWork.action': string;
  'openWork.kicker': string;
  'openWork.title': string;
  'openWork.lede': string;
  'openWork.manage': string;
  'openWork.routeLabel': string;
  'openWork.routeValue': string;
  'openWork.keepLabel': string;
  'openWork.keepValue': string;
  'openWork.excludeLabel': string;
  'openWork.excludeValue': string;
  'openWork.catalogTitle': string;
  'openWork.catalogSubtitle': string;
  'openWork.empty': string;
  'openWork.searchPlaceholder': string;
  'openWork.searchAria': string;
  'openWork.filtersAria': string;
  ...
  'assistant.usageCost': string;
  'assistant.usageMeasured': string;
  'assistant.usageEstimated': string;
  'assistant.usageUnavailable': string;
  'assistant.usageCoverage': string;
  'assistant.usageScopeConversation': string;
  'assistant.usageScopeResponse': string;
  'assistant.usageHintMeasured': string;
  'assistant.usageHintEstimated': string;
  'assistant.usageHintUnavailable': string;
  'assistant.usageUnits': string;
  'assistant.usageUnitTokens': string;
  'assistant.usageUnitUsd': string;
  'assistant.usageUnitUsdWhenAvailable': string;
  'assistant.usageCostUnavailable': string;
  'assistant.usageCostUnavailableHint': string;
  'assistant.usageMethod': string;
  'assistant.usageTokenDefinition': string;
  'assistant.usageTotalDefinition': string;
  'assistant.usageCacheDefinition': string;
  'assistant.usageReasoningDefinition': string;
  'assistant.usageCostDefinition': string;
  'assistant.usageContextDefinition': string;
  'assistant.usageEstimateDefinition': string;
  ...
  'qf.fileUnavailable': string;
  'qf.fileUploading': string;
  'qf.fileUploadFailed': string;
  'qf.fileLocation': string;
  'qf.dbChooseConnection': string;
  'qf.dbProjectRequired': string;
  'qf.domainBusinessCode': string;
  'qf.domainOwner': string;
  'qf.domainNote': string;
  'qf.domainMappingEmpty': string;
  'qf.dbChooseSchema': string;
  'qf.dbAllSchemas': string;
  'qf.dbChooseTable': string;
  'qf.dbNoConnections': string;
  'qf.dbLoading': string;
  'qf.dbAttached': string;
  'qf.dbConcurrency': string;
  'qf.dbConcurrencyHint': string;
  'qf.dbAttachSelected': string;
  'qf.dbSelectAll': string;
  'qf.dbSelectSchemaAll': string;
  'qf.dbClearSelection': string;
  'qf.dbFindCandidates': string;
  'qf.dbFindingCandidates': string;
  'qf.dbCandidatesFound': string;
  'qf.dbCandidatesNone': string;
  'qf.dbNoTablesForCandidates': string;
  'qf.dictionaryChoose': string;
  'qf.dictionaryEmpty': string;
  'qf.dictionaryPreviewFailed': string;
  'qf.dictionarySaved': string;
  'qf.dictionaryUpload': string;
  'qf.dictionaryUploadHint': string;
  'qf.dictionaryUploadCancel': string;
  'qf.dictionaryScopeProject': string;
  'qf.dictionaryScopeLibrary': string;
  'qf.dictionaryProjectScopeHint': string;
  'qf.dictionaryLibraryScopeHint': string;
  'qf.dictionaryProjectUpload': string;
  'qf.dictionaryLibraryUpload': string;
  'qf.dictionaryProjectUploadTarget': string;
  'qf.dictionaryLibraryUploadTarget': string;
  'qf.dictionaryLibraryName': string;
  'qf.dictionaryAttach': string;
  'qf.dictionaryAttached': string;
  'qf.dictionaryLibraryEmpty': string;
  'qf.dictionaryVersion': string;
...
// Screen-spec structured editor
  'screenSpec.loading': string;
  'screenSpec.loadFailed': string;
  'screenSpec.invalidJson': string;
  'screenSpec.reload': string;
  'screenSpec.reloadTitle': string;
  'screenSpec.save': string;
  'screenSpec.saveDirty': string;
  'screenSpec.saving': string;
  'screenSpec.saved': string;
  'screenSpec.fileChangedOnDisk': string;
  'screenSpec.reloadFromDisk': string;
  'screenSpec.fatalIssues': string;
  'screenSpec.screenFallback': string;
  'screenSpec.addScreen': string;
  'screenSpec.deleteScreen': string;
  'screenSpec.deleteScreenConfirm': string;
  'screenSpec.uploadImage': string;
  'screenSpec.previewHeight': string;
  'screenSpec.fitImageRatio': string;
  'screenSpec.imageTypeError': string;
  'screenSpec.imageReadError': string;
  'screenSpec.emptyImageTitle': string;
  'screenSpec.emptyImageHint': string;
  'screenSpec.markerAria': string;
  'screenSpec.defaultCalloutLabel': string;
  'screenSpec.descriptionTitle': string;
  'screenSpec.colLabel': string;
  'screenSpec.colDescription': string;
  'screenSpec.emptyCallouts': string;
  'screenSpec.labelAria': string;
  'screenSpec.descriptionAria': string;
  'screenSpec.delete': string;
  'screenSpec.add': string;
  'screenSpec.relationsTitle': string;
  'screenSpec.relationsHint': string;
  'screenSpec.addRelation': string;
  'screenSpec.needTwoMarkers': string;
  'screenSpec.emptyRelations': string;
  'screenSpec.relationFrom': string;
  'screenSpec.relationTo': string;
  'screenSpec.lineMode': string;
  'screenSpec.lineStraight': string;
  'screenSpec.lineOrthogonal': string;
  'screenSpec.relationLabel': string;
  ...
  'development.folderRequired': string;
  'development.serverStatus': string;
  'development.ready': string;
  'development.starting': string;
  'development.failed': string;
  'development.stopped': string;
  'development.runConfiguration': string;
  'development.noConfiguration': string;
  'development.stop': string;
  'development.start': string;
  'development.detectAgain': string;
  'development.database': string;
  'development.noDatabase': string;
  ...
  'gitChanges.files': string;
  'gitChanges.noRepository': string;
  'gitChanges.noChanges': string;
  'gitChanges.openFile': string;
  'gitChanges.patch': string;
  'gitChanges.viewMode': string;
  'gitChanges.splitView': string;
  'gitChanges.unifiedView': string;
  'gitChanges.before': string;
  'gitChanges.after': string;
  'gitChanges.binary': string;
  'gitChanges.truncated': string;
  'gitChanges.emptyPatch': string;
  'gitChanges.loadFailed': string;
  'screenSpec.checkpointTitle': string;
  'screenSpec.checkpointAria': string;
  'screenSpec.newCheckpointPlaceholder': string;
  'screenSpec.metadataTitle': string;
  'screenSpec.pageTitle': string;
  'screenSpec.screenId': string;
  'screenSpec.screenName': string;
  'screenSpec.screenPath': string;
  'screenSpec.overview': string;
  'screenSpec.addLevel': string;
  'screenSpec.deleteLevelAria': string;
  'screenSpec.companyName': string;
