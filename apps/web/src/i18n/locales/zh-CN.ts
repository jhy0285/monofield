...
export const zhCN: Dict = {
  ...
  'pluginsHome.subtitle': '精选 Open Docs 模板，用于快速开始规格说明、演示文稿、文档和原型。选择一个即可载入起始提示词，也可以打开完整模板库。',
  'pluginsHome.browseRegistry': '查看全部模板',
  'pluginsHome.count': '{filtered} / {total}',
  'pluginsHome.loadingCatalog': '正在加载模板…',
  'pluginsHome.emptyCatalog': '暂时没有可用模板。Open Docs 内置模板应会自动显示在这里；如果问题持续，请重启 daemon。',
  ...
  'designFiles.usefulInfoTip5': '没有想法？试试首页“模板图库”里的模板。',
