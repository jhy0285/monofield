...
export const en: Dict = {
  ...
  'assistant.usageConversation': 'Model usage in this conversation',
  'assistant.usageInput': 'New input',
  'assistant.usageCached': 'Cache reused · included',
  'assistant.usageOutput': 'Output',
  'assistant.usageReasoning': 'Reasoning',
  'assistant.usageTotal': 'Total',
  ...
  'assistant.usageScopeConversation': 'This adds the AI-response usage reported by the selected model or CLI. It is not MonoField-only overhead: it includes the runtime\'s own instructions, tools, conversation history, and the relevant project context MonoField sends. Browser and file tabs do not start a new conversation.',
  'assistant.usageScopeResponse': 'This is not a count of extra tokens added by MonoField. It is the full input processed and reported by the selected model or CLI, including the runtime\'s own instructions, tools, conversation history, and the relevant project context MonoField sends. The same short question can show a large baseline when sent directly to that model or CLI.',
  'assistant.usageHintMeasured': 'The full run value reported by the selected model provider or CLI runtime.',
  ...
  'assistant.usageTotalDefinition': 'Total uses the provider total when available; otherwise it is input + output.',
  'assistant.usageCacheDefinition': 'Cache reused is the provider-reported cached portion of input. New input subtracts it from input; total already includes it exactly once.',
  ...
  'assistant.usageContextDefinition': 'A first response includes the model or CLI base instructions and tool schemas. Providers and CLIs report this input as one combined total, so MonoField cannot precisely isolate only the context it added. Cached input in a new conversation can mean a stable prefix was reused; it does not mean an earlier conversation was loaded.',
