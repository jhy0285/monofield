...
export const en: Dict = {
  ...
  'assistant.usageConversation': 'This conversation',
  ...
  'assistant.usageScopeConversation': 'Only assistant responses in this conversation are added. Browser and file tabs do not start a new conversation.',
  'assistant.usageScopeResponse': 'Input includes the full model context for this response, not just the latest message.',
  'assistant.usageHintMeasured': 'Reported by the active model provider or CLI runtime.',
  ...
  'assistant.usageContextDefinition': 'A first response includes the model or CLI base instructions and tool schemas. A provider may reuse that stable prefix from cache even in a new conversation; it is not prior conversation content.',
