...
export const en: Dict = {
  ...
  'settings.privacyHint': 'Model provider policy; no Open Docs telemetry',
  'settings.privacyConsentKicker': 'How data is handled',
  'settings.privacyConsentLead': 'Open Docs does not send product telemetry or store conversation/tool content on an Open Docs server. When you run an agent, input is sent only to the local CLI or BYOK/model provider you choose, and that provider policy applies.',
  'settings.privacyConsentFooter': 'This build has no Open Docs telemetry switch. Local project data stays on your machine unless you explicitly send it to a selected model provider or external integration.',
  ...
  'settings.privacyConsentBannerFooter': 'Open Docs does not send product telemetry. Model input is sent only to the CLI or model provider you choose.',
  'settings.privacyConsentPolicyLink': 'Read the privacy policy',
  'settings.privacyMetrics': 'Open Docs telemetry',
  'settings.privacyMetricsHint': 'Disabled. No product analytics, startup reports, reliability events, or quality traces are sent to Open Docs.',
  ...
  'settings.privacyDataDeletionHint': 'Clears any legacy anonymous ID and keeps Open Docs telemetry disabled. Inputs already sent to a model provider follow that provider policy.',
  ...
  'homeHero.title': 'What document work should we do today?',
  ...
  'pluginsHome.title': 'Template Gallery',
  'pluginsHome.subtitle': 'Curated Open Docs templates for quickly starting specs, decks, documents, and prototypes. Pick one to load a starter prompt, or open the full template library.',
  'pluginsHome.browseRegistry': 'View all templates',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading templates…',
  'pluginsHome.emptyCatalog': 'No templates are available yet. Bundled Open Docs templates should appear here automatically — try restarting the daemon if this persists.',
  'pluginsHome.emptyFiltered': 'No templates match the current filters.',
  'pluginsHome.clearFilters': 'Clear filters',
  'pluginsHome.modeAria': 'Template gallery mode',
  ...
  'pluginsHome.searchPlaceholder': 'Search templates…',
  'pluginsHome.searchAria': 'Search templates',
  ...
  'designFiles.usefulInfoTip5': 'Out of ideas? Try a template from the Template Gallery on the Home page.',
