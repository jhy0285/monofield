...
export const en: Dict = {
  ...
  'homeHero.title': 'One field. Every kind of work.',
  ...
  'useEverywhere.section.overview.intro': 'MonoField is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  ...
  'useEverywhere.section.mcp.intro': 'MonoField ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover MonoField tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
...
// Screen-spec structured editor
  ...
  'qf.fileLocation': 'Uploads are stored in .open-docs/question-inputs in this project.',
  ...
  'workMode.creation': 'Create documents and designs',
