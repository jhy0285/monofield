...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to MonoField\'s official AMR model service — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying MonoField? Star us on GitHub.',
  ...
  'critiqueTheater.settingsNavHint': 'Five-panel review for final documents and visual work',
  'critiqueTheater.settingsEnabledLabel': 'Use Design Jury for new runs in this project',
  'critiqueTheater.settingsEnabledDescription': 'Reviews design, brand, accessibility, and copy before export. It adds model calls, time, and token usage, so enable it only when a final document or visual deliverable needs the extra review.',
  ...
  'updater.availableBody': 'MonoField {version} is available. It will download before the installer can open.',
  ...
  'community.checkInTitle': 'Is MonoField working well for you?',
  'community.checkInBody': 'This one-time check appears after a few completed tasks. Your answer stays on this device.',
  'community.worksWell': 'Yes, it works well',
  'community.later': 'Maybe later',
  'community.starTitle': 'Help MonoField keep improving',
  'community.starBody': 'If MonoField has been useful, a GitHub Star is a simple way to support the project.',
  'community.starAction': 'Star on GitHub',
  'community.onboardingBody': 'MonoField is open source and keeps improving with its users.',
...
// Screen-spec structured editor
  ...
  'productTutorial.eyebrow': 'FIRST RUN / 4 STEPS',
  ...
  'development.guideMeta': 'DEVELOPMENT / 5 STEPS',
  ...
  'development.guideVerifyBody': 'With Auto verify on, opening the local app shows one origin approval. After approval, the agent checks DOM and screenshots in that same tab and exercises the changed interaction with pointer-backed click, hover, and drag.',
