...
export const en: Dict = {
  'chat.amrCard.switchTitle': 'Model call failed',
  'chat.amrCard.switchBody': 'Try the request again first. If it keeps failing, report the problem on GitHub.',
  'chat.amrCard.chipOfficial': 'Open GitHub issue',
  'chat.amrCard.chipNoKey': 'Report a problem',
  'chat.amrCard.chipAutoRetry': 'Try again first',
  'chat.amrCard.switchCta': 'Open GitHub issue',
  ...
  'chat.runError.signInMessage.amr': 'The MonoField agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the MonoField agent — steadier and better value.',
  ...
  'plugins.actions.openHomepage': 'Original source',
  ...
  'settings.welcomeTitle': 'Welcome to MonoField',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. MonoField will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. MonoField reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to MonoField AMR to continue.',
  ...
  'settings.byokNoFileToolsNotice': 'BYOK can chat and create previewable text artifacts, but it cannot read or edit the working folder, run native tools, query the project database, or drive browser verification. For those project-connected capabilities, choose a Local CLI adapter that supports them.',
  'settings.codeAgent': 'Code agent',
  'settings.codeAgentHint': 'Pick the CLI that runs your prompts.',
  'settings.rescan': '↻ Rescan agents & models',
  'settings.rescanTitle': 'Rescan installed agents and their model catalogs',
  'settings.rescanRunning': 'Scanning...',
  'settings.rescanSuccess': 'Agent and model scan complete. {count} available.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the MonoField daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to MonoField.',
  ...
  'settings.amrCloud': 'MonoField AMR',
  ...
  'settings.appearanceHint': 'Choose a light, dark, or system base theme, then apply one accent color to buttons, selections, and focus states.',
  'settings.appearanceThemeTitle': 'Base theme',
  'settings.appearanceThemeHint': 'Controls the neutral app surfaces. System follows your operating system.',
  'settings.themeSystem': 'System',
  'settings.themeLight': 'Light',
  'settings.themeDark': 'Dark',
  'settings.accentTitle': 'Accent color',
  'settings.accentHint': 'Applied consistently to primary actions, selected controls, and keyboard focus. Status colors stay semantic.',
  'settings.accentDefault': 'Default monochrome',
  'settings.accentPreset': 'Accent preset',
  'settings.accentCustom': 'Custom color',
  'settings.accentHexLabel': 'HEX value',
  'settings.accentInvalid': 'Enter a six-digit HEX color such as #2563eb.',
  'settings.appearancePreview': 'Component preview',
  'settings.appearancePreviewButton': 'Primary action',
  'settings.appearancePreviewSelected': 'Selected',
  'settings.appearancePreviewFocus': 'Keyboard focus',
  ...
  'settings.mcpServerHint': 'Expose MonoField as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'Model provider policy; no MonoField telemetry',
  'settings.privacyConsentKicker': 'How data is handled',
  'settings.privacyConsentLead': 'MonoField does not send product telemetry or store conversation/tool content on an MonoField server. When you run an agent, input is sent only to the local CLI or BYOK/model provider you choose, and that provider policy applies.',
  'settings.privacyConsentFooter': 'This build has no MonoField telemetry switch. Local project data stays on your machine unless you explicitly send it to a selected model provider or external integration.',
  'settings.privacyConsentShare': 'Not applicable',
  'settings.privacyConsentDecline': 'Not applicable',
  'settings.privacyConsentAccept': 'I get it',
  'settings.privacyConsentBannerFooter': 'MonoField does not send product telemetry. Model input is sent only to the CLI or model provider you choose.',
  'settings.privacyConsentPolicyLink': 'Read the privacy policy',
  'settings.privacyMetrics': 'MonoField telemetry',
  'settings.privacyMetricsHint': 'Disabled. No product analytics, startup reports, reliability events, or quality traces are sent to MonoField.',
  'settings.privacyContent': 'Model and agent input',
  'settings.privacyContentHint': 'Prompts, files, tool input, and outputs are sent only to the selected local CLI, BYOK provider, model endpoint, or external integration needed for the task.',
  'settings.privacyInstallationId': 'Anonymous ID',
  'settings.privacyOptedOut': 'not used',
  'settings.privacyDataDeletion': 'Clear local privacy state',
  'settings.privacyDataDeletionHint': 'Clears any legacy anonymous ID and keeps MonoField telemetry disabled. Inputs already sent to a model provider follow that provider policy.',
  'settings.about': 'About',
  'settings.aboutHint': 'Version and runtime details',
  'settings.aboutDescriptor': 'code / design / documents',
  'settings.aboutTrustLine': 'Local-first · Open source · Model-independent',
  'settings.openSourceNoticesTitle': 'Open-source notices',
  'settings.openSourceNoticesBody': 'MonoField is an independent product built on Apache-2.0 licensed Open Design code. It is not affiliated with, endorsed by, or maintained by the Open Design project.',
  'settings.openSourceNoticesUpstream': 'View the upstream Open Design project',
  'settings.openSourceNoticesDistribution': 'LICENSE, NOTICE, and THIRD_PARTY_NOTICES.md are included with source and desktop distributions.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your MonoField projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure MonoField is running, then reopen this panel.',
  'settings.mcpBuildDaemon': 'Build the daemon first.',
  'settings.mcpNodeMissing': 'Node binary is missing.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js is missing. Run `pnpm build:daemon` and refresh.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in MonoField, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'MonoField must be running for MCP tool calls to succeed. If you started your coding agent before opening MonoField, restart the agent so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Contact MonoField by email',
  'entry.discordAriaWithOnline': 'Contact MonoField by email',
  ...
  'entry.navOpenWork': 'Library',
  'entry.navTasks': 'Automations',
  'entry.navPlugins': 'Plugins',
  'entry.navDesignSystems': 'Brand & styles',
  'entry.navBrands': 'Document Style',
  'entry.navIntegrations': 'Integrations',
  'entry.featureGuide': 'Feature guide',
  'workspaceTabs.project': 'Project',
  'workspaceTabs.pluginDetails': 'Plugin details',
  'workspaceTabs.marketplace': 'Marketplace',
  'homeHero.title': 'One workspace, every kind of work',
  'homeHero.startWithTemplate': 'Choose an output',
  'homeHero.startBlankProject': '…or start a blank project',
  'homeHero.templatePicker.label': 'Output',
  'homeHero.templatePicker.searchPlaceholder': 'Search outputs',
  'homeHero.templatePicker.projectTypes': 'Available outputs',
  'homeHero.templatesScrollHint': 'Scroll up to explore more outputs',
  'homeHero.templatesCollapse': 'Collapse outputs',
  'homeHero.subtitlePrefix': 'code / design / documents',
  'homeHero.trustLine': 'For everyone turning ideas into outcomes.',
  'homeHero.placeholder': 'Describe what you want to make, change, or understand…',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable MonoField plugin and add it to My plugins.',
  ...
  'homeHero.chip.templateHint': 'Reuse a saved project setup.',
  ...
  'homeHero.chip.screenSpecDesc': 'Screen docs & PPTX specs',
  'homeHero.chip.interfaceSpecDesc': 'API interface spec workbooks',
  ...
  'homeHero.chip.screenSpecNext': 'Open a screen-spec project with screen capture, markers, Description, and Check Point.',
  'homeHero.chip.interfaceSpecNext': 'Scan a codebase into interface-spec.json and export the Korean SI-style XLSX workbook.',
  ...
  'homeWorkingDir.hint': 'Use this folder as the agent code root for reading, editing, builds, and tests. Files are not copied into MonoField.',
  ...
  'handoff.promptIntro': 'Continue from this local MonoField project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. MonoField Systems to view the full preview.',
  ...
  'homeOpenWork.kicker': 'LIBRARY',
  'homeOpenWork.title': 'Start with a proven workflow',
  'homeOpenWork.body': 'Preview a result, inspect its reusable setup, and bring only that setup into a new task.',
  'homeOpenWork.action': 'Explore the library',
  'openWork.kicker': 'LIBRARY',
  'openWork.title': 'Reuse proven ways of working.',
  'openWork.lede': 'Browse reusable workflows and finished examples. Bring the format, guidance, and tools into a new task—never source code, uploaded files, database values, or credentials.',
  'openWork.manage': 'Manage workflows',
  'openWork.routeLabel': 'How it works',
  'openWork.routeValue': 'Preview → inspect the workflow → start a new task',
  'openWork.keepLabel': 'What comes with it',
  'openWork.keepValue': 'Output format · instructions · tool recipe · reusable defaults',
  'openWork.excludeLabel': 'What stays behind',
  'openWork.excludeValue': 'Source code · uploaded files · database values · credentials',
  'openWork.catalogTitle': 'Reusable workflows',
  'openWork.catalogSubtitle': 'Choose a result to inspect its reusable setup and begin a new task with the same workflow.',
  'openWork.empty': 'No workflows are available yet. Install a plugin to add one to the library.',
  'openWork.searchPlaceholder': 'Search the library…',
  'openWork.searchAria': 'Search the library',
  'openWork.filtersAria': 'Library filters',
  'pluginsHome.title': 'Workflow library',
  'pluginsHome.subtitle': 'Reusable workflows for specs, decks, documents, prototypes, and more. Pick one to load its tools, guidance, and starting brief.',
  'pluginsHome.browseRegistry': 'View all workflows',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading workflows…',
  'pluginsHome.emptyCatalog': 'No workflows are available yet. Bundled workflows should appear here automatically — try restarting the daemon if this persists.',
  'pluginsHome.emptyFiltered': 'No workflows match the current filters.',
  'pluginsHome.clearFilters': 'Clear filters',
  'pluginsHome.modeAria': 'Workflow library mode',
  'pluginsHome.featured': 'Saved',
  'pluginsHome.totalInCatalog': '{n} workflows',
  ...
  'pluginsHome.searchPlaceholder': 'Search workflows…',
  'pluginsHome.searchAria': 'Search workflows',
  ...
  'pluginsView.teamBody': 'Connect the company-managed catalog that distributes approved plugins, skills, and templates to every MonoField desktop user.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to MonoField',
  'pluginCard.contributeTitle': 'Contribute plugin to MonoField with a pull request',
  'skillPluginCandidate.createForMe': 'Create plugin/template',
  'skillPluginCandidate.contributeToMain': 'Contribute to MonoField',
  'skillPluginCandidate.repoDescription': 'This repo looks like it could work as a plugin.',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use MonoField from other IDEs, scripts, and automations.',
  ...
  'mcpClient.subtitle': 'Only enabled servers are passed to the selected local CLI for that run. Their credentials are visible to that CLI process, so enable only servers you trust.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure MonoField is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use MonoField everywhere',
  'useEverywhere.modalTitle': 'Use MonoField everywhere',
  'useEverywhere.modalSubtitle': 'Drop MonoField into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'MonoField works wherever your agent works',
  'useEverywhere.section.overview.intro': 'MonoField is more than a window — it is a local privileged daemon (`monofield`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `monofield <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires MonoField as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without MonoField at all.',
  ...
  'useEverywhere.section.overview.footer': 'MonoField keeps runtime data in its local app-data directory. Set `MONOFIELD_DATA_DIR=~/.monofield` only when you need a custom shared location.',
  'useEverywhere.section.cli.tab': 'CLI · monofield',
  'useEverywhere.section.cli.heading': 'Drive MonoField from any shell',
  'useEverywhere.section.cli.intro': 'The `monofield` bin ships with the daemon and is the same binary used by Claude Code / Codex when they run a generation. Most subcommands are thin clients that POST to the local daemon, so they work the same whether you launched it via `pnpm tools-dev` or as a packaged app.',
  'useEverywhere.section.cli.bullet1': '`monofield` (no args) — boots the daemon and opens the web UI.',
  'useEverywhere.section.cli.bullet2': '`monofield media generate ...` — produce image / video / audio bytes through the unified media protocol.',
  'useEverywhere.section.cli.bullet3': '`monofield run ...` — start a project run from a prompt + skill.',
  'useEverywhere.section.cli.bullet4': '`monofield plugin install <source>` / `monofield plugin apply <id>` — install and apply community plugins.',
  'useEverywhere.section.cli.bullet5': '`monofield skills list` / `monofield design-systems list` — inspect what is available locally.',
  'useEverywhere.section.cli.bullet6': '`monofield status` / `monofield doctor` — verify daemon health and detect agent CLIs on your PATH.',
  ...
  'useEverywhere.section.mcp.heading': 'Expose MonoField as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'MonoField ships with a Model Context Protocol server (`monofield mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover MonoField tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  'useEverywhere.section.mcp.bullet1': 'Stdio transport — no extra port, the client spawns `monofield mcp` directly.',
  ...
  'useEverywhere.section.mcp.bullet4': 'Pins `MONOFIELD_DATA_DIR` so the spawned MCP process writes to the same place the daemon already uses (avoids EPERM in packaged macOS app bundles).',
  ...
  'useEverywhere.section.mcp.footer': 'In the MonoField app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': 'Same REST + SSE surface the web UI uses',
  'useEverywhere.section.http.intro': 'The local daemon serves an HTTP API at `http://127.0.0.1:7456` (port configurable). Every endpoint the web UI calls is also fair game for your scripts. Streaming endpoints (chat turns, project runs) emit Server-Sent Events with the contract types in `packages/contracts`.',
  ...
  'useEverywhere.section.http.footer': 'Pure TypeScript types for every request/response live in `packages/contracts` — import them in your script for full autocomplete without wiring a generator.',
  'useEverywhere.section.skills.tab': 'Skills & headless',
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without MonoField running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). MonoField extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside MonoField and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.bullet4': 'Headless: an agent with `monofield` on its PATH can call `monofield skills list` then run any skill; the daemon is optional for read-only flows.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + MonoField extras)',
  ...
  'entry.helpReportProblem': 'Report a problem',
  ...
  'entry.githubStarTitle': 'Star MonoField on GitHub',
  'entry.githubStarAria': 'Star MonoField on GitHub',
  ...
  'newproj.tabTemplate': 'Saved preset',
  ...
  'newproj.titleTemplate': 'Start from a saved preset',
  ...
  'newproj.templateLabel': 'Project preset',
  'newproj.noTemplatesTitle': 'No saved presets yet',
  'newproj.noTemplatesBody': 'Open any project, then use the Share menu inside the file viewer to save its setup as a project preset. Saved presets appear here.',
  'newproj.savedTemplate': 'Saved preset',
  'newproj.fileSingular': 'file',
  'newproj.filePlural': 'files',
  'newproj.create': 'Create',
  'newproj.locationLabel': 'Save to',
  'newproj.locationDefault': 'MonoField projects',
  'newproj.locationExternalBase': 'External base',
  'newproj.createLiveArtifact': 'Create live artifact',
  'newproj.createFromTemplate': 'Create from preset',
  'newproj.createDisabledTitle': 'Save a project preset first (Share menu inside any project).',
  'newproj.importClaudeZip': 'Import MonoField ZIP',
  'newproj.importClaudeZipTitle': 'Import an MonoField .zip export',
  ...
  'newproj.deleteTemplateTitle': 'Delete preset',
  'newproj.deleteTemplateConfirm': 'Delete “{name}”? This cannot be undone.',
  'newproj.deleteTemplateConfirmCta': 'Delete preset',
  'newproj.deleteTemplateError': 'Could not delete this preset. Please try again.',
  ...
  'socialShare.openDesignSection': 'Share MonoField',
  'socialShare.openDesignTitle': 'MonoField on GitHub',
  'socialShare.openDesignText': 'MonoField is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectTitle': '{title} · MonoField',
  'socialShare.projectText': 'Built with MonoField: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with MonoField: {title}\n{url}\nMonoField repo: {repo}',
  ...
  'chat.brandBrowserAssistDesktopOnly': 'Browser assist needs the desktop app so MonoField can read the live browser page.',
  'chat.brandBrowserAssistReadFailed': 'Could not read the browser page. Make sure the brand site is open and fully loaded.',
  'chat.brandBrowserAssistMessage': 'MonoField needs browser assist to finish this brand extraction. Clear the page in the Browser tab, then confirm below.',
  'brandEnrichment.title': "AI Optimize",
  'brandEnrichment.body': "MonoField will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask MonoField to change {file}...',
  'chat.designArtifactsShowMore': 'Show {count} more docs files',
  'chat.mode.chat.label': 'Ask',
  'chat.mode.chat.title': 'Ask mode',
  'chat.mode.chat.summary': 'For explanations, reviews, planning, and software development without forcing a document workflow.',
  'chat.mode.chat.solves': 'Use it for code changes, builds, tests, database or browser work, and questions about existing documents.',
  'chat.mode.chat.query1': 'Fix this bug, run the tests, and verify it in the browser.',
  'chat.mode.chat.query2': 'Explain this architecture and compare the available options.',
  'chat.mode.chat.query3': 'Review this document and list concrete improvements without creating a new file.',
  'chat.mode.design.label': 'Docs',
  'chat.mode.design.title': 'Docs mode',
  'chat.mode.design.summary': 'For creating, editing, validating, or exporting concrete outputs such as specifications, decks, spreadsheets, prototypes, and project documents.',
  'chat.mode.design.solves': 'Use it whenever a file or structured deliverable is required, including technical specifications inside a software project.',
  'chat.mode.design.query1': 'Create a technical specification for this feature from the connected codebase.',
  'chat.mode.design.query2': 'Turn this user flow into a screen specification with fields, validation, and edge cases.',
  'chat.mode.design.query3': 'Build and export an interactive prototype for this product flow.',
  ...
  'browserUse.summary': '{count} web actions, prioritizing asset extraction, design language, motion, visual checks, and component structure. Each action records bounded evidence for the composer.',
  ...
  'preview.shareTemplateBadge': 'Project preset',
  ...
  'preview.copyTemplateLink': 'Copy preset link',
  ...
  'preview.shareTextDefault': 'MonoField template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure MonoField is running and try again.',
  'preview.retry': 'Retry',
  ...
  'preview.nounTemplate': 'this preset',
  'preview.showSidebar': 'Show {label}',
  'preview.hideSidebar': 'Hide {label}',
  'misc.savedTemplate': 'Saved preset',
  ...
  'designFiles.usefulInfoTip5': 'Out of ideas? Explore finished examples in Open Work.',
  ...
  'designFiles.usefulInfoTip14': 'Happy with a project? Save it as a project preset from the Share menu and reuse it anytime.',
  ...
  'fileViewer.saveAsTemplate': 'Save as project preset…',
  'fileViewer.savingTemplate': 'Saving preset…',
  'fileViewer.savedTemplate': 'Saved preset “{name}”',
  'fileViewer.savedTemplateFail': 'Could not save preset — try again.',
  'fileViewer.templateNamePrompt': 'Preset name',
  'fileViewer.templateNameDefault': 'Untitled preset',
  'fileViewer.templateDescPrompt': 'Short description (optional — what makes this preset useful?)',
  ...
  'assistant.shareToOpenDocs': 'Share to MonoField',
  'assistant.shareToOpenDocsBusy': 'Preparing package…',
  'assistant.feedbackPrompt': 'Rate this response',
  'assistant.feedbackPositive': 'Helpful',
  'assistant.feedbackNegative': 'Needs improvement',
  'assistant.feedbackReasonTitle': 'What influenced your rating?',
  ...
  'assistant.feedbackReasonSubmit': 'Save feedback',
  ...
  'assistant.usage': 'Cumulative model usage',
  'assistant.usageConversation': 'Cumulative usage in this conversation',
  'assistant.usageInputTotal': 'Total input · all calls',
  'assistant.usageInput': 'New input',
  'assistant.usageCached': 'Cache reused · input subset',
  'assistant.usageOutput': 'Output · all calls',
  'assistant.usageReasoning': 'Reasoning',
  'assistant.usageTotal': 'Input + output',
  'assistant.usageCost': 'Cost',
  'assistant.usageMeasured': 'Measured',
  'assistant.usageEstimated': 'Estimated',
  'assistant.usageUnavailable': 'Unavailable',
  'assistant.usageCoverage': '{measured} of {total} responses measured',
  'assistant.usageScopeConversation': 'Sum of the measured responses in this conversation. Each response can include several model calls, so this is cumulative traffic—not the size of one current context window. A large cached total (for example 7 million) means calls collectively reused that much input; it does not mean the model opened a 7-million-token context. This is not MonoField-only overhead.',
  'assistant.usageScopeResponse': 'Cumulative usage for all model calls made to produce this response—not the size of one current context window and not extra MonoField-only usage. It includes the runtime\'s base instructions, tools, conversation history, and relevant project context. A large cached total (for example 7 million) means those calls collectively reused that much input.',
  'assistant.usageHintMeasured': 'The selected model or CLI reported these cumulative run values. Cached input and reasoning are shown as subsets and are not added again.',
  'assistant.usageHintEstimated': 'Estimated from request and response length; not billing-grade.',
  'assistant.usageHintUnavailable': 'This provider did not return token usage for the response.',
  'assistant.usageUnits': 'Units',
  'assistant.usageUnitTokens': 'tokens',
  'assistant.usageUnitUsd': 'USD',
  'assistant.usageUnitUsdWhenAvailable': 'USD when reported',
  'assistant.usageCostUnavailable': 'Not reported',
  'assistant.usageCostUnavailableHint': 'The provider or CLI did not return a USD amount for this run. Subscription or credit usage and API-key billing are different, so MonoField does not invent an API-dollar estimate.',
  'assistant.usageMethod': 'Units and calculation',
  'assistant.usageTokenDefinition': 'Tokens are model tokenizer units, not characters or words. The same text can use different counts across models.',
  'assistant.usageTotalDefinition': 'Total input is the sum across calls in this response. Input + output uses the provider total when available; otherwise it is total input + output. Cached input and reasoning are not added again.',
  'assistant.usageCacheDefinition': 'Cache reused is a subset of total input reported as a cache read. New input = total input − cache reused. Input newly written to a cache is new input, not reused input.',
  'assistant.usageReasoningDefinition': 'Reasoning is shown only when reported separately. It is usually already included in output or total and is not added again.',
  'assistant.usageCostDefinition': 'USD appears only when the provider or CLI reports a billing amount for this run.',
  'assistant.usageContextDefinition': 'A first response includes the model or CLI base instructions and tool schemas. Tool-using work can invoke the model repeatedly, and every call can process or reuse much of the same prefix. The displayed cumulative input can therefore exceed the model context-window size. Cached input in a new conversation can mean a stable prefix was reused; it does not mean an earlier conversation was loaded.',
  'assistant.usageEstimateDefinition': 'Estimated usage uses roughly one token per four characters; cache, reasoning, and cost are not estimated.',
  ...
  'artifact.odCardBrandAssistBody': 'Open the brand site in the browser so MonoField can continue extracting this document style.',
  ...
  'critiqueTheater.userFacingName': 'HTML Design Review (Experimental)',
  ...
  'critiqueTheater.settingsNav': 'HTML Design Review (Experimental)',
  'critiqueTheater.settingsNavHint': 'Experimental five-role review for generated HTML only',
  'critiqueTheater.settingsEnabledLabel': 'Review generated HTML in new project runs',
  'critiqueTheater.settingsEnabledDescription': 'Reviews HTML output from design, brand, accessibility, and copy perspectives before delivery. It does not review arbitrary documents, code, spreadsheets, or slide files. Extra model calls increase time and token usage, so it remains off by default.',
  'critiqueTheater.settingsEnabledProjectHint': 'Saved for this project. New HTML-generation runs can route through the experimental review server-side.',
  ...
  'pet.title': 'Pets',
  'pet.subtitle': 'After adoption, Show pet places an always-on-top companion at the bottom-right of Desktop. Click it to see active agent work.',
  'pet.navTitle': 'Pets',
  'pet.navHint': 'Adopt or customize',
  'pet.tabBuiltIn': 'Built-in',
  'pet.tabBuiltInHint': 'Curated companions bundled with MonoField — pick one and adopt.',
  ...
  'pet.wake': 'Show pet',
  'pet.tuck': 'Hide pet',
  'pet.wakeTitle': 'Show the floating pet at the bottom-right of Desktop.',
  'pet.tuckTitle': 'Keep the adoption and hide only the floating Desktop pet.',
  ...
  'pet.codexBundledTitle': 'Ships with MonoField — no download needed.',
  ...
  'settings.notifyCompletionSoundHint': 'Plays when your requested task is complete. Off by default.',
  ...
  'settings.designSystemsHint': 'Manage document styles available to the agent and new-project picker',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple MonoField project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions MonoField should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'settings.memoryStarterProjectDesc': 'MonoField v0.5 — chat-driven design editor',
  ...
  'settings.memoryHooksExtractionDesc': 'Optional. Runs an extra model request after each chat turn to capture durable facts and preferences.',
  ...
  'notify.successBody': 'Your requested task is complete.',
  'notify.failureBody': 'Your requested task could not be completed. Open MonoField to review the error.',
  'notify.questionTitle': 'A question is waiting',
  'notify.questionBody': 'The agent is waiting for your answer.',
  'updater.available': 'Update available',
  'updater.availableBody': 'MonoField {version} is available. Open the release page to choose and download the installer for your system.',
  'updater.channelBeta': 'Beta channel',
  'updater.channelPrerelease': 'Prerelease channel',
  'updater.channelPreview': 'Preview channel',
  'updater.channelStable': 'Stable channel',
  ...
  'updater.installerOpenBody': 'The installer is open. MonoField is quitting so you can finish the update.',
  ...
  'updater.payloadReadyGeneric': 'A new MonoField update is ready. MonoField will close and restart automatically.',
  'updater.payloadReadyVersion': 'MonoField {version} is ready. MonoField will close and restart automatically.',
  'updater.quitButton': 'Quit MonoField',
  'updater.quitFailedBody': 'The installer is open, but MonoField could not quit. Quit MonoField before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. MonoField will close and open the installer.',
  'updater.readyVersion': 'MonoField {version} is ready. MonoField will close and open the installer.',
  'updater.upToDate': 'You\'re already on the latest version.',
  'community.checkInTitle': 'How has MonoField been working for you?',
  'community.checkInBody': 'Is it working well, or is there something you would like us to improve?',
  'community.worksWell': 'It works well',
  'community.shareFeedback': 'Share feedback',
  'community.later': 'Close',
  'community.starTitle': 'We will keep making MonoField better',
  'community.starBody': 'If MonoField has helped, support it with a GitHub Star.',
  'community.starAction': 'Star MonoField',
  'community.onboardingBody': 'If MonoField helps your work, support its next improvements with a GitHub Star.',
  ...
  'dsManager.createBody': 'Teach MonoField your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions MonoField follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach MonoField your document styles — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'MonoField turns your brand into a reusable document style — then keeps everything you build on-brand and consistent.',
  ...
  'dsCreate.sourceSectionBody': 'Start with a GitHub repo, website, DESIGN.md, or files that show your style. MonoField first creates a usable system quickly, then AI can refine it inside the project.',
  ...
  'ds.extractionRunningBody': 'MonoField is updating this system in place.',
  ...
  'ds.repoConnectBannerBody': 'Connect GitHub so MonoField can read your repository and pull colors, type, and components into this document style.',
...
// Screen-spec structured editor
  'screenSpec.loading': 'Loading screen spec…',
  'screenSpec.loadFailed': 'Could not load the screen-spec file.',
  'screenSpec.invalidJson': 'This file is not valid screen-spec JSON.',
  'screenSpec.reload': 'Reload',
  'screenSpec.reloadTitle': 'Reload from disk (discards unsaved edits)',
  'screenSpec.save': 'Save',
  'screenSpec.saveDirty': 'Save changes',
  'screenSpec.saving': 'Saving…',
  'screenSpec.saved': 'Saved',
  'screenSpec.fileChangedOnDisk': 'This file changed on disk while you were editing.',
  'screenSpec.reloadFromDisk': 'Discard my edits and reload',
  'screenSpec.fatalIssues': '{count} blocking issue(s) — fix before export:',
  'screenSpec.screenFallback': 'Screen {no}',
  'screenSpec.addScreen': 'Add screen',
  'screenSpec.deleteScreen': 'Delete screen',
  'screenSpec.deleteScreenConfirm': 'Delete this screen and all of its markers?',
  'screenSpec.uploadImage': 'Upload image',
  'screenSpec.previewHeight': 'Preview height',
  'screenSpec.fitImageRatio': 'Fit to image ratio',
  'screenSpec.imageTypeError': 'Only PNG, JPG, JPEG, or WEBP images can be uploaded.',
  'screenSpec.imageReadError': 'Could not read the image file.',
  'screenSpec.emptyImageTitle': 'Image upload area',
  'screenSpec.emptyImageHint': 'Upload an image, then click it to add markers.',
  'screenSpec.markerAria': 'Marker {no}: {label}',
  'screenSpec.defaultCalloutLabel': 'Item {no}',
  'screenSpec.descriptionTitle': 'Description',
  'screenSpec.colLabel': 'Label',
  'screenSpec.colDescription': 'Description',
  'screenSpec.emptyCallouts': 'Click the image to add the first marker.',
  'screenSpec.labelAria': 'Label for marker {no}',
  'screenSpec.descriptionAria': 'Description for marker {no}',
  'screenSpec.delete': 'Delete',
  'screenSpec.add': 'Add',
  'screenSpec.relationsTitle': 'Marker relations',
  'screenSpec.relationsHint': 'e.g. Clicking button 1 opens popup 2.',
  'screenSpec.addRelation': 'Add relation',
  'screenSpec.needTwoMarkers': 'At least two markers are needed to draw a relation line.',
  'screenSpec.emptyRelations': 'Press Add relation to connect markers with a red line.',
  'screenSpec.relationFrom': 'From',
  'screenSpec.relationTo': 'To',
  'screenSpec.lineMode': 'Line style',
  'screenSpec.lineStraight': 'Straight',
  'screenSpec.lineOrthogonal': 'Orthogonal',
  'screenSpec.relationLabel': 'Label',
  'screenSpec.relationLabelPlaceholder': 'e.g. Opens popup on click',
  'screenSpec.markerSize': 'Marker size',
  'screenSpec.lineWidth': 'Line width',
  'screenSpec.checkpointTitle': 'Check Point',
  'screenSpec.checkpointAria': 'Checkpoint {no}',
  'screenSpec.newCheckpointPlaceholder': 'Enter a checkpoint',
  'screenSpec.metadataTitle': 'Metadata',
  'screenSpec.pageTitle': 'Page title',
  'screenSpec.screenId': 'Screen ID',
  'screenSpec.screenName': 'Screen name',
  'screenSpec.screenPath': 'Screen path',
  'screenSpec.overview': 'Overview',
  'screenSpec.addLevel': 'Add level',
  'screenSpec.deleteLevelAria': 'Delete level {no}',
  'screenSpec.companyName': 'Company',
  'screenSpec.author': 'Author',
  'screenSpec.date': 'Date',
  'screenSpec.version': 'Version',
  'settings.databaseTitle': 'Database connections',
  'settings.databaseSubtitle': 'Encrypted PostgreSQL connection for project work.',
  'settings.databaseNavHint': 'Project database connection',
  'settings.databaseUnavailable': 'Database connections are available only in the MonoField desktop app.',
  'settings.databaseSecurityHint': 'Projects store only a connection ID. The URL, username, and password stay in the Desktop operating-system-encrypted store, and agents receive only narrow structured database commands—never credentials or the connection URL.',
  'settings.databaseDevelopmentTitle': 'Available during normal development',
  'settings.databaseDevelopmentHint': 'After saving and selecting a connection for a project, the local CLI agent can inspect it and, when allowed, prepare structured test-data writes for relevant backend, API, migration, or test work. It does not query the database for unrelated work.',
  'settings.databaseUseExample': '“Use the Development database when implementing and testing this API.”',
  'settings.databaseCurrentCapability': 'Policy controlled',
  'settings.databaseWriteRoadmap': 'Choose one connection access level: Read only, Ask before every write, or Always allow. Writable modes accept only structured INSERT/UPDATE/DELETE, use transactions and row caps, and create an audit log. DDL and arbitrary SQL remain blocked.',
  'settings.databaseReadApproval': 'Read permission',
  'settings.databaseReadApprovalPrompt': 'Ask every time',
  'settings.databaseReadApprovalAlways': 'Always allow read-only access',
  'settings.databaseReadApprovalSaved': 'Database read permission updated.',
  'settings.databaseName': 'Name', 'settings.databaseNamePlaceholder': 'Analytics DB', 'settings.databaseHost': 'Host', 'settings.databasePort': 'Port', 'settings.databaseDatabase': 'Database', 'settings.databaseUsername': 'Username', 'settings.databasePassword': 'Password',
  'settings.databaseRequired': 'Enter a name, host, database, username, and password.', 'settings.databaseTesting': 'Testing secure connection...', 'settings.databaseSaving': 'Saving encrypted connection...', 'settings.databaseTestSucceeded': 'Connection succeeded.', 'settings.databaseSaved': 'Saved with OS-backed encryption. Password is not shown again.', 'settings.databaseLoadFailed': 'Unable to load database connections.', 'settings.databaseConnectionFailed': 'Database connection failed.', 'settings.databaseTest': 'Test connection', 'settings.databaseSave': 'Save encrypted connection', 'settings.databaseRemove': 'Remove',
  'qf.fileUnavailable': 'File upload is available after the project opens.',
  'qf.fileUploading': 'Uploading to this project...',
  'qf.fileUploadFailed': 'File upload failed.',
  'qf.fileLocation': 'Uploads are stored in _monofield/question-inputs in this project.',
  'qf.dbChooseConnection': 'Choose a saved database connection...',
  'qf.dbProjectRequired': 'Open this question in a project to store approved database context safely.',
  'qf.domainBusinessCode': 'Business code',
  'qf.domainOwner': 'Owner',
  'qf.domainNote': 'Note',
  'qf.domainMappingEmpty': 'No API domains were proven by the code scan.',
  'qf.dbChooseSchema': 'Choose a schema',
  'qf.dbAllSchemas': 'All schemas',
  'qf.dbChooseTable': 'Choose a table to attach its schema and redacted sample...',
  'qf.dbNoConnections': 'No saved connections. Add one in Settings > Database connections.',
  'qf.dbLoading': 'Approval complete. Reading selected tables...',
  'qf.dbAttached': 'Schema and redacted sample attached to this answer.',
  'qf.dbConcurrency': 'Read concurrency',
  'qf.dbConcurrencyHint': 'Higher values may finish sooner but use more database connections. Use 8 for production databases.',
  'qf.dbAttachSelected': 'Attach {count} selected table(s)',
  'qf.dbSelectAll': 'Select all',
  'qf.dbSelectSchemaAll': 'Select all in this schema',
  'qf.dbClearSelection': 'Clear',
  'qf.dbFindCandidates': 'Find code-based candidates',
  'qf.dbFindingCandidates': 'Scanning code for table references...',
  'qf.dbCandidatesFound': 'Selected {count} code-matched table(s).',
  'qf.dbCandidatesNone': 'No selected table was found in mapper/SQL files from the linked code folder. Check the folder and table names.',
  'qf.dbNoTablesForCandidates': 'Load a schema and its tables before scanning the codebase.',
  'qf.dictionaryChoose': 'Choose a saved dictionary...',
  'qf.dictionaryEmpty': 'No project dictionaries yet. Use Upload dictionary to add one.',
  'qf.dictionaryPreviewFailed': 'Could not load this dictionary preview.',
  'qf.dictionarySaved': 'Saved dictionaries',
  'qf.dictionaryUpload': 'Upload dictionary',
  'qf.dictionaryUploadHint': 'Choose where to save this dictionary, then select its file.',
  'qf.dictionaryUploadCancel': 'Cancel',
  'settings.dictionaryLibraryTitle': 'Dictionary library',
  'settings.dictionaryLibrarySubtitle': 'Reusable mapping dictionaries and immutable project snapshots.',
  'settings.dictionaryLibraryNavHint': 'Reusable dictionaries',
  'dictionaryLibrary.add': 'Add dictionary',
  'dictionaryLibrary.name': 'Dictionary name',
  'dictionaryLibrary.namePlaceholder': 'Korean-English terms',
  'dictionaryLibrary.empty': 'No global dictionaries yet.',
  'dictionaryLibrary.versions': 'Versions',
  'dictionaryLibrary.uploadVersion': 'Upload new version',
  'dictionaryLibrary.rename': 'Rename',
  'dictionaryLibrary.delete': 'Delete library',
  'dictionaryLibrary.deleteConfirm': 'Delete this global dictionary? Existing project snapshots will remain available.',
  'dictionaryLibrary.loading': 'Saving dictionary...',
  'dictionaryLibrary.saved': 'Dictionary saved.',
  'dictionaryLibrary.uploadFailed': 'Dictionary upload failed.',
  'dictionaryLibrary.previewEmpty': 'No preview is available for this file.',
  'qf.dictionaryScopeProject': 'This project',
  'qf.dictionaryScopeLibrary': 'My library',
  'qf.dictionaryProjectScopeHint': 'Use a dictionary already saved in this project.',
  'qf.dictionaryLibraryScopeHint': 'Choose a reusable dictionary version. MonoField copies it into this project before it is used.',
  'qf.dictionaryProjectUpload': 'Upload to this project',
  'qf.dictionaryLibraryUpload': 'Add to my library',
  'qf.dictionaryProjectUploadTarget': 'Save only in this project',
  'qf.dictionaryLibraryUploadTarget': 'Save to global library',
  'qf.dictionaryLibraryName': 'Library dictionary name',
  'qf.dictionaryAttach': 'Use this version',
  'qf.dictionaryAttached': 'Project snapshot connected: {name} v{version}',
  'qf.dictionaryLibraryEmpty': 'No reusable dictionaries yet. Use Upload dictionary or manage them in Settings > Dictionary library.',
  'qf.dictionaryVersion': 'Version {version}',
  'settings.databaseAccessPolicySaved': 'Database access policy saved.',
  'settings.databaseEnvironment': 'Environment',
  'settings.databaseEnvironmentDevelopment': 'Development',
  'settings.databaseEnvironmentTest': 'Test',
  'settings.databaseEnvironmentProduction': 'Production',
  'settings.databaseWritePolicy': 'Connection access',
  'settings.databaseWriteDisabled': 'Read only',
  'settings.databaseWriteApproveEach': 'Ask before every write',
  'settings.databaseWriteAlways': 'Always allow structured writes',
  'productTutorial.eyebrow': 'FIRST RUN / 8 STEPS',
  'productTutorial.title': 'Follow the workspace into your first task.',
  'productTutorial.body': 'The rest of the interface dims while the next control stays in focus. Use the highlighted control or move to the next step.',
  'productTutorial.promptLabel': 'EXAMPLE REQUEST',
  'productTutorial.developmentPrompt': 'Update the order API, run the project, and verify the flow in the browser.',
  'productTutorial.creationPrompt': 'Use the code and glossary to create and validate an interface specification.',
  'productTutorial.progressLabel': 'Tutorial progress',
  'productTutorial.stepOf': 'STEP {current} OF {total}',
  'productTutorial.stepChooseTitle': 'Choose how you want to work',
  'productTutorial.stepChooseBody': 'Select software development or documents / design in the highlighted area. Using the actual control advances the tour.',
  'productTutorial.stepConnectTitle': 'Connect a working folder',
  'productTutorial.stepConnectBody': 'Open the folder control and choose the project the agent may read and edit. If this document task needs no folder, use Next to skip it.',
  'productTutorial.stepAskTitle': 'Describe the outcome you want',
  'productTutorial.stepAskBody': 'Type the desired result in the highlighted composer. Add files, visual marks, or database context only when they provide useful evidence.',
  'productTutorial.stepReviewTitle': 'Send the request and review the result',
  'productTutorial.stepReviewBody': 'Start the task with Send. Review development work in the diff, build, and browser; review document work in preview, validation, and export.',
  'productTutorial.creationChooseTitle': 'Switch to documents / design',
  'productTutorial.creationChooseBody': 'Use the highlighted Documents / design control. The same project workspace can produce specifications, decks, prototypes, sites, and images.',
  'productTutorial.creationFormatTitle': 'Choose the result format',
  'productTutorial.creationFormatBody': 'Open Result format and choose a screen specification, interface specification, deck, prototype, or another deliverable. Selecting an item advances the tour.',
  'productTutorial.creationStyleTitle': 'Choose the brand and document style',
  'productTutorial.creationStyleBody': 'Open Brand & style and choose the design system for the result. Leave it empty to start with the MonoField default.',
  'productTutorial.creationComposeTitle': 'Add evidence and start creating',
  'productTutorial.creationComposeBody': 'Use + to connect files, templates, or a glossary, describe the intended result, and send. Continue in preview to edit, validate, and export the finished work.',
  'productTutorial.close': 'Close tutorial',
  'productTutorial.download': 'Download the full user guide',
  'productTutorial.previous': 'Previous',
  'productTutorial.next': 'Next',
  'productTutorial.finish': 'Start MonoField',
  'productTutorial.reopen': 'Product guide',
  'productTutorial.reopenMeta': '8-step development + documents / design tour',
  'workMode.label': 'How will you work?',
  'workMode.development': 'Develop software',
  'workMode.creation': 'Documents / design',
  'workMode.developmentHint': 'Connect a code folder, run the app, use approved database context, and verify changes in the browser.',
  'workMode.creationHint': 'Create specifications, decks, prototypes, sites, images, and other structured work.',
  'workMode.developmentFolderRequired': 'Choose the code project folder before starting development.',
  ...
  'development.guideDatabaseBody': 'Choose a development connection from Settings > Database. The project stores only its connection ID; credentials stay in the Desktop vault. The agent receives only the selected read, approved-write, or full-access policy.',
  'development.guideChangesTitle': 'Review every code change',
  'development.guideChangesBody': 'Finally open Changes for the before / after diff. Compare is read-only; Switch changes the real working branch. With uncommitted files, choose Keep or Stash before switching.',
  'development.guideVerifyTitle': 'Verify the screen and interactions',
  'development.guideVerifyBody': 'With Auto verify on, opening the local app shows one origin approval. After approval, MonoField always checks the DOM and a screenshot in that tab. When it is safe, the agent also exercises the changed interaction with pointer-backed click, hover, or drag. The result reports screen and interaction evidence separately.',
  'development.detectFailed': 'Could not detect a run configuration.',
  'development.startFailed': 'Could not start the development server.',
  'development.stopFailed': 'Could not stop the development server.',
  'development.folderRequired': 'Connect a project folder to use development tools.',
  'development.serverStatus': 'Development server status',
  'development.ready': 'Ready',
  'development.starting': 'Starting',
  'development.failed': 'Failed',
  'development.stopped': 'Stopped',
  'development.runConfiguration': 'Run configuration',
  'development.noConfiguration': 'No run configuration found',
  'development.stop': 'Stop',
  'development.start': 'Run',
  ...
  'development.runSettingsHint': 'For example, choose a Spring Boot local/dev/prod profile and arguments such as --server.port=9081. They apply only to this run; project application files are not modified.',
  'development.springProfile': 'Spring profile',
  'development.springProfilePlaceholder': 'local, dev, prod, or a custom profile',
  'development.additionalArguments': 'Additional application arguments',
  'development.invalidArguments': 'The application arguments are invalid.',
  'development.logs': 'Execution logs',
  'development.logsEmpty': 'No execution logs yet.',
  'gitChanges.title': 'Changes',
  'gitChanges.description': 'Review working tree and staged Git patches',
  'gitChanges.branch': 'Branch view',
  'gitChanges.currentBranch': 'Uncommitted work on current branch',
  'gitChanges.compareBranch': 'Compare commits',
  'gitChanges.branchHint': 'The current view shows uncommitted working-tree and staged changes. Commit comparison shows committed differences between the selected branch and the current HEAD without checking it out.',
  'gitChanges.manageBranches': 'Branches',
  'gitChanges.workingBranch': 'Working branch',
  'gitChanges.workingBranchHint': 'Switching changes the branch used by files, runs, diffs, and the CLI agent.',
  'gitChanges.switchBranch': 'Switch to branch',
  'gitChanges.remoteBranch': 'remote',
  'gitChanges.switchAction': 'Switch',
  'gitChanges.newBranch': 'New branch from current HEAD',
  'gitChanges.createAndSwitch': 'Create & switch',
  'gitChanges.uncommittedTitle': 'Uncommitted changes',
  'gitChanges.uncommittedHint': 'Cancel, carry these changes to the target branch, or store them in Git stash before switching.',
  'gitChanges.keepAndSwitch': 'Keep & switch',
  'gitChanges.stashAndSwitch': 'Stash & switch',
  'gitChanges.branchCreated': 'Created and switched to the new branch.',
  'gitChanges.branchSwitched': 'The working branch was switched.',
  'gitChanges.branchActionFailed': 'Could not change the Git branch.',
  'gitChanges.refresh': 'Refresh Git',
  'gitChanges.working': 'Working tree',
  'gitChanges.staged': 'Staged',
  'gitChanges.files': 'Changed files',
  'gitChanges.noRepository': 'This working folder is not a Git repository.',
  'gitChanges.noChanges': 'No changes in this view.',
  'gitChanges.openFile': 'Open file',
  'gitChanges.patch': 'Git patch',
  'gitChanges.viewMode': 'Diff view',
  'gitChanges.splitView': 'Side by side',
  'gitChanges.unifiedView': 'Unified',
  'gitChanges.before': 'Before',
  'gitChanges.after': 'After',
  'gitChanges.binary': 'Binary files cannot be previewed as text.',
  'gitChanges.truncated': 'This large diff was truncated for display.',
  'gitChanges.emptyPatch': 'No patch content is available.',
  'gitChanges.loadFailed': 'Could not load Git changes.',
};
