...
export const zhTW: Dict = {
  ...
  'chat.amrCard.switchTitle': '模型呼叫失敗',
  'chat.amrCard.switchBody': '請先重試。如果問題持續發生，請在 GitHub 回報。',
  'chat.amrCard.chipOfficial': '開啟 GitHub Issue',
  'chat.amrCard.chipNoKey': '回報問題',
  'chat.amrCard.chipAutoRetry': '先重試',
  'chat.amrCard.switchCta': '開啟 GitHub Issue',
  ...
  'chat.runError.signInMessage.amr': 'MonoField 智慧體尚未登入，前往登入即可正常使用',
  'chat.runError.signInMessage.other': '{agent}尚未登入，請在本機檢查登入狀態。推薦使用 MonoField 智慧體，更穩定划算',
  ...
  'plugins.actions.openHomepage': '原始來源',
  ...
  'settings.welcomeTitle': '歡迎使用 MonoField',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': '從一句需求開始',
  'settings.onboardingCreateBody': '描述你想做的網站、應用、Deck、圖片或影片，MonoField 會建立專案，並保留可繼續編輯的產出。',
  ...
  'settings.onboardingMemoryCalloutBody': '這些回答會構成你的記憶檔案。MonoField 會在每個任務中重複使用它，並在你工作時持續學習。',
  ...
  'settings.onboardingCloudTitle': '登入 MonoField',
  'settings.onboardingCloudBody': '登入後可直接用雲端 AI 開始設計，無需任何複雜設定。',
  'settings.onboardingCloudSignIn': '登入 MonoField 雲端',
  ...
  'settings.onboardingGateTooltipAmr': '後續流程由 AI 執行，請先登入 MonoField AMR。',
  ...
  'settings.agentInstall.pathHint': '如果你透過 npm 或 Homebrew 安裝了 CLI，但仍顯示為未安裝，請確認該工具的 bin 目錄已加入 MonoField daemon 繼承的 PATH（在 macOS 上，Terminal 與 GUI 應用的 PATH 可能不同）。請參閱 QUICKSTART.md（「Local agent CLI and PATH」章節）。',
  'settings.agentInstall.stepOpenLinks': '在目標代理卡片上開啟「安裝」或「文件」連結。',
  'settings.agentInstall.stepAuth': '返回 MonoField 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。',
  ...
  'settings.mcpServerHint': '將 MonoField 作為 MCP 伺服器暴露給你的編碼代理。',
  ...
  'settings.aboutDescriptor': '程式碼 / 設計 / 文件',
  ...
  'settings.mcpHint': '讓其他專案中的程式碼代理（Claude Code、Cursor、VS Code、Antigravity、Zed、Windsurf）讀取您的 MonoField 專案。您可以直接將設計匯入應用程式，無需先匯出 zip。',
  'settings.mcpDaemonError': '無法連線到本地守護程序以解析安裝路徑（{error}）。請確認 MonoField 正在執行，然後重新開啟此面板。',
  'settings.mcpBuildDaemon': '請先建置守護行程。',
  'settings.mcpNodeMissing': '缺少 Node 執行檔。',
  'settings.mcpBuildHint': '缺少 apps/daemon/dist/cli.js。請執行 `pnpm build:daemon` 後重新整理。',
  ...
  'settings.mcpCapabilityDefault': '預設使用您在 MonoField 中開啟的專案與檔案，因此您可以說「在我的應用程式中建置這個」，無需重新說明是哪個設計。',
  'settings.mcpRunningNote': 'MonoField 必須正在執行，MCP 工具呼叫才能成功。如果您在開啟 MonoField 之前就已啟動 coding agent，請重新啟動 agent，使其能夠連線到正在執行的守護行程。',
  ...
  'homeHero.subtitlePrefix': '程式碼 / 設計 / 文件',
  ...
  'homeHero.chip.screenSpec': '畫面規格說明',
  ...
  'homeHero.chip.createPluginHint': '編寫可重複使用的 MonoField 外掛並將其加入「我的外掛」。',
  ...
  'homeHero.chip.screenSpecDesc': '畫面文件與 PPTX 規格',
  ...
  'homeHero.chip.screenSpecNext': '開啟包含畫面擷取、標記、Description 與 Check Point 的畫面規格專案。',
  ...
  'homeWorkingDir.hint': '將此資料夾用作 Agent 讀取、編輯、建置與測試程式碼的工作根目錄。檔案不會複製到 MonoField。',
  ...
  'handoff.promptIntro': '請基於這個 MonoField 專案的本機資料夾繼續實作：',
  ...
  'pluginsHome.title': '範本圖庫',
  'pluginsHome.subtitle': '精選 MonoField 範本，用於快速開始規格文件、簡報、文件與原型。選擇一個即可載入起始提示詞，也可以開啟完整範本庫。',
  'pluginsHome.browseRegistry': '查看全部範本',
  'pluginsHome.count': '{total} 個中的 {filtered} 個',
  'pluginsHome.loadingCatalog': '正在載入範本…',
  'pluginsHome.emptyCatalog': '目前沒有可用範本。MonoField 內建範本應會自動顯示在這裡；如果問題持續，請重新啟動 daemon。',
  'pluginsHome.emptyFiltered': '沒有範本符合目前篩選條件。',
  'pluginsHome.clearFilters': '清除篩選條件',
  'pluginsHome.modeAria': '範本圖庫模式',
  'pluginsHome.featured': '已儲存',
  'pluginsHome.totalInCatalog': '{n} 個範本',
  'pluginsHome.categoryFilterAria': '類別篩選',
  'pluginsHome.subcategoryFilterAria': '{label} 子類別篩選',
  'pluginsHome.allCategory': '所有{label}',
  'pluginsHome.searchPlaceholder': '搜尋範本…',
  'pluginsHome.searchAria': '搜尋範本',
  ...
  'pluginCard.contributeAria': '將 {title} 貢獻至 MonoField',
  'pluginCard.contributeTitle': '透過 pull request 將外掛貢獻至 MonoField',
  ...
  'integrations.lede': '連接外部系統，把 MCP 工具帶入智能體迴圈，並在其他 IDE、腳本與自動化流程中使用 MonoField。',
  ...
  'mcpClient.daemonError': '無法連線到本機 daemon。請確認 MonoField 正在執行，然後重新開啟此面板。',
  'mcpClient.saveFailed': '儲存失敗。請確認 daemon 正在執行後再試一次。',
  'useEverywhere.modalAria': '隨處使用 MonoField',
  'useEverywhere.modalTitle': '隨處使用 MonoField',
  'useEverywhere.modalSubtitle': '將 MonoField 接入任何 IDE、Agent 或指令碼 — CLI、HTTP、MCP 及 Skills。使用「複製 Agent 指南」並貼到 Claude Code、Codex、Cursor、openclaw 或 hermes 中，即可設定一切。',
  ...
  'useEverywhere.section.overview.heading': '你的 Agent 在哪裡運作，MonoField 就在哪裡運作',
  'useEverywhere.section.overview.intro': 'MonoField 不只是一個視窗 — 它是一個本機特權 daemon（`monofield`），外加一個 Skills + Design-Systems + Atoms 登錄。一旦它在您的機器上執行，任何程式碼 Agent（Claude Code、Codex、Cursor、OpenCode/openclaw、Hermes、您自己的指令碼）都能透過四個可互換的介面來驅動產生作業、檢視專案並產出設計成品。',
  'useEverywhere.section.overview.bullet1': 'CLI — 以 `monofield <command>` 用於無頭指令碼、CI 及 shell 自動化。',
  'useEverywhere.section.overview.bullet2': 'MCP server — 將 MonoField 接成 Model Context Protocol 伺服器，讓任何支援 MCP 的 Agent 都能列出技能、執行情境並讀取成品。',
  'useEverywhere.section.overview.bullet3': 'HTTP API — `http://127.0.0.1:7456/api/*` REST + SSE 端點；與網頁 UI 使用的介面相同。',
  'useEverywhere.section.overview.bullet4': 'Skills — 隨插即用的 `SKILL.md` 套件（相容於 Claude），任何已在您 PATH 上的 Agent 完全無需 MonoField 即可調用。',
  ...
  'useEverywhere.section.cli.heading': '從任何 shell 操作 MonoField',
  'useEverywhere.section.cli.intro': '`monofield` 執行檔隨 daemon 一起發佈，與 Claude Code / Codex 執行產生作業時所用的是同一個二進位檔。多數子指令都是精簡的用戶端，會 POST 至本機 daemon，因此無論你是透過 `pnpm tools-dev` 啟動，還是以打包後的應用程式執行，運作方式都相同。',
  'useEverywhere.section.cli.bullet1': '`monofield`（無參數）— 啟動 daemon 並開啟網頁 UI。',
  'useEverywhere.section.cli.bullet2': '`monofield media generate ...` — 透過統一的媒體協定產生圖片／影片／音訊位元組。',
  'useEverywhere.section.cli.bullet3': '`monofield run ...` — 從提示 + 技能啟動一次專案執行。',
  'useEverywhere.section.cli.bullet4': '`monofield plugin install <source>` / `monofield plugin apply <id>` — 安裝並套用社群外掛。',
  'useEverywhere.section.cli.bullet5': '`monofield skills list` / `monofield design-systems list` — 檢視本機可用的項目。',
  'useEverywhere.section.cli.bullet6': '`monofield status` / `monofield doctor` — 驗證 daemon 健康狀態並偵測您 PATH 上的 Agent CLI。',
  ...
  'useEverywhere.section.mcp.heading': '將 MonoField 以 MCP 伺服器形式開放給任何程式設計 Agent',
  'useEverywhere.section.mcp.intro': 'MonoField 隨附一個 Model Context Protocol 伺服器（`monofield mcp`），讓任何支援 MCP 的用戶端 — Cursor、Claude Code、Antigravity、VS Code Copilot Chat、openclaw、hermes — 都能探索 MonoField 工具（列出技能、算繪預覽、產生媒體、執行外掛），而無需手動使用 shell。daemon 透過 `GET /api/mcp/install-info` 為每個主要用戶端發布可直接貼上的安裝程式碼片段。',
  'useEverywhere.section.mcp.bullet1': 'Stdio 傳輸 — 不需額外連接埠，用戶端直接產生 `monofield mcp` 程序。',
  ...
  'useEverywhere.section.mcp.bullet4': '固定 `MONOFIELD_DATA_DIR`，讓衍生的 MCP 程序寫入 daemon 已使用的相同位置（避免在 macOS 打包應用程式套件中發生 EPERM）。',
  ...
  'useEverywhere.section.mcp.footer': '在 MonoField 應用程式中，開啟「設定 → 整合」即可複製特定用戶端的安裝指令（Cursor、Claude Code、Antigravity、VS Code），而無需手動編輯 JSON。',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': '與 web UI 所用相同的 REST + SSE 介面',
  'useEverywhere.section.http.intro': '本機 daemon 會在 `http://127.0.0.1:7456` 提供 HTTP API（連接埠可設定）。web UI 呼叫的每個端點，你的指令稿同樣可以使用。串流端點（聊天回合、專案執行）會發出 Server-Sent Events，其合約型別定義於 `packages/contracts`。',
  ...
  'useEverywhere.section.http.footer': '每個請求／回應的純 TypeScript 型別都位於 `packages/contracts` 中 — 在您的指令碼中匯入它們，即可享有完整的自動完成，而無需接上產生器。',
  'useEverywhere.section.skills.tab': '技能與無頭模式',
  'useEverywhere.section.skills.heading': '適用於任何 Agent 的隨插即用 Skills — 即使 MonoField 未在執行也行',
  'useEverywhere.section.skills.intro': 'Skill 是一個包含相容於 Claude 的 `SKILL.md`（YAML 前置資料 + 內文）的目錄。MonoField 以 `od:` 命名空間（`mode`、`preview`、`design_system`、`inputs`、…）擴充此格式，因此同一個成品既能在 MonoField 內使用，也能被像 Claude Code、Codex、openclaw 或 hermes 這類原生 Agent 使用。探索作業遵循一條優先順序鏈，因此專案可覆寫自己的技能。',
  ...
  'useEverywhere.section.skills.bullet4': '無頭模式：PATH 中含有 `monofield` 的 Agent 可呼叫 `monofield skills list`，接著執行任何技能；唯讀流程中 daemon 為選用。',
  'useEverywhere.section.skills.bullet5': '`pnpm seed:test-projects` 會以預設外掛範例與社群外掛範例演練相同的成品結構，接著將產生的 `index.html` 專案儲存為可重複使用的測試資料。',
  'useEverywhere.section.skills.snippet1': '最精簡的 SKILL.md（Claude 相容的前置資料 + MonoField 額外設定）',
  ...
  'entry.githubStarAria': '在 GitHub 為 MonoField 點亮 Star',
  ...
  'newproj.locationDefault': 'MonoField 專案',
  ...
  'socialShare.openDesignSection': '分享 MonoField',
  'socialShare.openDesignTitle': 'GitHub 上的 MonoField',
  'socialShare.openDesignText': 'MonoField 是開源的設計智慧工作區，可以生成、編輯、部署並交付設計產物。',
  ...
  'socialShare.projectText': '我用 MonoField 做了 {title}。查看已部署產物，也推薦收藏倉庫：{repo}',
  'socialShare.projectCopyText': '我用 MonoField 做了 {title}\n{url}\nMonoField 倉庫：{repo}',
  ...
  'chat.brandBrowserAssistDesktopOnly': '瀏覽器輔助需要桌面應用，MonoField 才能讀取即時瀏覽器頁面。',
  'chat.brandBrowserAssistReadFailed': '無法讀取瀏覽器頁面。請確認品牌網站已開啟並完整載入。',
  'chat.brandBrowserAssistMessage': 'MonoField 需要瀏覽器輔助才能完成這次品牌擷取。請先在 Browser 分頁清除頁面攔截，然後在下方確認。',
  'brandEnrichment.title': "AI 優化",
  'brandEnrichment.body': "MonoField 會在背景執行更深度的抽取，自動套用合適的設計系統 skills，並就地更新這個系統。通常需要 10-20 分鐘，你可以繼續做其他事。",
  ...
  'chat.activeFilePlaceholder': '讓 MonoField 修改 {file}...',
  'chat.designArtifactsShowMore': '再顯示 {count} 個設計檔案',
  'chat.mode.chat.label': '詢問',
  'chat.mode.chat.title': '詢問模式',
  'chat.mode.chat.summary': '用於說明、審查、規劃和軟體開發，不強制進入文件建立流程。',
  'chat.mode.chat.solves': '適用於程式碼修改、建置、測試、資料庫或瀏覽器操作，以及對既有文件的提問。',
  'chat.mode.chat.query1': '總結這份稿子，並指出還缺什麼。',
  'chat.mode.chat.query2': '幫我判斷這個落地頁應該怎麼組織結構。',
  'chat.mode.chat.query3': '看一下這個設計，給我具體的改進建議。',
  'chat.mode.design.label': '文件',
  'chat.mode.design.title': '文件模式',
  'chat.mode.design.summary': '用於建立、編輯、驗證或匯出規格、簡報、試算表、原型和專案文件等具體成果。',
  'chat.mode.design.solves': '需要檔案或結構化成果時使用，包括軟體專案中的技術規格。',
  ...
  'preview.shareTextDefault': 'MonoField 模板：{title}',
  ...
  'preview.errorBody': '範例 HTML 載入失敗。請確認 MonoField 正在執行後重試。',
  'preview.retry': '重試',
  ...
  'designFiles.usefulInfoTip5': '沒有想法？到 Open Work 查看已完成的範例。',
  ...
  'assistant.shareToOpenDocs': '分享到 MonoField',
  ...
  'pet.navHint': '領養與自訂',
  'pet.tabBuiltIn': '內建',
  'pet.tabBuiltInHint': 'MonoField 內建的精選寵物 — 一鍵領養。',
  ...
  'pet.codexBundled': '內建',
  'pet.codexBundledTitle': 'MonoField 內建寵物，無需下載。',
  ...
  'settings.projectLocationsDescription': '新增可包含多個 MonoField 專案資料夾的工作基目錄。新專案會儲存為所選基目錄中的一個資料夾。',
  ...
  'settings.customInstructionsHint': 'MonoField 在每次聊天中都應遵循的固定指示。將事實、偏好與專案脈絡儲存為記憶。',
  ...
  'settings.memoryStarterProjectDesc': 'MonoField v0.5 — 聊天驅動的設計編輯器',
  ...
  'artifact.odCardBrandAssistBody': '在瀏覽器中開啟品牌網站，讓 MonoField 繼續擷取此設計體系。',
  ...
  'updater.availableBody': 'MonoField {version} 新版本已發布。開啟發佈頁面，選擇並下載適合你系統的安裝程式。',
  'updater.channelBeta': '測試版頻道',
  'updater.channelPrerelease': '預發佈頻道',
  'updater.channelPreview': '預覽頻道',
  'updater.channelStable': '穩定版頻道',
  ...
  'updater.done': '完成',
  'updater.failed': '更新失敗',
  'updater.installerOpenBody': '安裝器已開啟。MonoField 正在結束，以便你完成更新。',
  ...
  'updater.openReleasePage': '開啟發佈頁面',
  ...
  'updater.quitButton': '結束 MonoField',
  'updater.quitFailedBody': '安裝器已開啟，但 MonoField 無法結束。替換應用程式前請先結束 MonoField。',
  'updater.quitFailedTitle': '無法結束',
  'updater.quitting': '正在結束…',
  'updater.ready': '更新已就緒',
  'updater.readyGeneric': '新版本已就緒。MonoField 會關閉並開啟安裝器。',
  'updater.readyVersion': 'MonoField {version} 已就緒。MonoField 會關閉並開啟安裝器。',
  'updater.upToDate': '您已經是最新版本啦',

  'community.checkInTitle': '使用 MonoField 的體驗如何？',
  'community.checkInBody': '使用是否順利？如果有希望我們改進的地方，請告訴我們。',
  'community.worksWell': '使用順利',
  'community.shareFeedback': '提交改進建議',
  'community.later': '關閉',
  'community.starTitle': '我們會繼續改善 MonoField',
  'community.starBody': '如果 MonoField 對你有幫助，歡迎在 GitHub 上給予 Star 支持。',
  'community.starAction': '為 MonoField 加上 Star',
  'community.onboardingBody': '如果 MonoField 對你的工作有幫助，歡迎用 GitHub Star 支持後續改善。',
  ...
  'dsManager.createBody': '把你的品牌、產品、程式碼、素材與設計參考教給 MonoField。',
  ...
  'settings.customInstructionsDesc': 'MonoField 在每次對話中都會遵循的固定指令。它們不是儲存的記憶；事實、偏好與專案脈絡請使用「記憶」。',
  ...
  'brand.librarySubtitle': '把你的品牌套件教給 MonoField——從網站擷取一個品牌套件，然後在任意對話中套用它。',
  ...
  'onboarding.buildBody': 'MonoField 將你的品牌沉澱為可重用的設計系統,讓你之後打造的一切都保持品牌一致。',
  ...
  'dsCreate.sourceSectionBody': '從 GitHub repo、網站、DESIGN.md 或能體現風格的檔案開始。MonoField 會先快速建立一套可用系統，之後 AI 可在專案中繼續細化。',
  ...
  'ds.extractionRunningBody': 'MonoField 正在就地更新此體系。',
  ...
  'ds.sectionRunningReadingContext': 'MonoField 正在讀取 {title} 的段落上下文。',
  ...
  'ds.repoConnectBannerBody': '連接 GitHub 後，MonoField 可以讀取你的儲存庫，並把顏色、字體和元件擷取到此設計體系中。',
  'ds.repoConnectCardBody': '從儲存庫中擷取顏色、字體和元件到此設計體系。',
  'ds.repoConnectButton': '連接 GitHub',
  // Screen-spec structured editor
  'screenSpec.loading': '正在載入畫面規格…',
  'screenSpec.loadFailed': '無法載入畫面規格檔案。',
  'screenSpec.invalidJson': '此檔案不是有效的畫面規格 JSON。',
  'screenSpec.reload': '重新載入',
  'screenSpec.reloadTitle': '從磁碟重新載入（捨棄未儲存的編輯）',
  'screenSpec.save': '儲存',
  'screenSpec.saveDirty': '儲存變更',
  'screenSpec.saving': '儲存中…',
  'screenSpec.saved': '已儲存',
  'screenSpec.fileChangedOnDisk': '編輯期間此檔案在磁碟上已被變更。',
  'screenSpec.reloadFromDisk': '捨棄我的編輯並重新載入',
  'screenSpec.fatalIssues': '{count} 個阻斷性問題 — 請在匯出前修正：',
  'screenSpec.screenFallback': '畫面 {no}',
  'screenSpec.addScreen': '新增畫面',
  'screenSpec.deleteScreen': '刪除畫面',
  'screenSpec.deleteScreenConfirm': '刪除此畫面及其所有標記？',
  'screenSpec.uploadImage': '上傳圖片',
  'screenSpec.previewHeight': '預覽高度',
  'screenSpec.fitImageRatio': '符合圖片比例',
  'screenSpec.imageTypeError': '僅支援上傳 PNG、JPG、JPEG 或 WEBP 圖片。',
  'screenSpec.imageReadError': '無法讀取圖片檔案。',
  'screenSpec.emptyImageTitle': '圖片上傳區域',
  'screenSpec.emptyImageHint': '上傳圖片後，點擊圖片即可新增標記。',
  'screenSpec.markerAria': '標記 {no}：{label}',
  'screenSpec.defaultCalloutLabel': '項目 {no}',
  'screenSpec.descriptionTitle': 'Description',
  'screenSpec.colLabel': '標籤',
  'screenSpec.colDescription': 'Description',
  'screenSpec.emptyCallouts': '點擊圖片以新增第一個標記。',
  'screenSpec.labelAria': '標記 {no} 的標籤',
  'screenSpec.descriptionAria': '標記 {no} 的說明',
  'screenSpec.delete': '刪除',
  'screenSpec.add': '新增',
  'screenSpec.relationsTitle': '標記關係',
  'screenSpec.relationsHint': '例如：點擊按鈕 1 開啟彈出視窗 2。',
  'screenSpec.addRelation': '新增關係',
  'screenSpec.needTwoMarkers': '至少需要兩個標記才能繪製關係線。',
  'screenSpec.emptyRelations': '按下「新增關係」以紅線連接標記。',
  'screenSpec.relationFrom': '起點',
  'screenSpec.relationTo': '終點',
  'screenSpec.lineMode': '線條樣式',
  'screenSpec.lineStraight': '直線',
  'screenSpec.lineOrthogonal': '直角折線',
  'screenSpec.relationLabel': '標籤',
  'screenSpec.relationLabelPlaceholder': '例如：點擊時開啟彈出視窗',
  'screenSpec.markerSize': '標記大小',
  'screenSpec.lineWidth': '線條粗細',
  'screenSpec.checkpointTitle': 'Check Point',
  'screenSpec.checkpointAria': '檢查點 {no}',
  'screenSpec.newCheckpointPlaceholder': '輸入檢查點',
  'screenSpec.metadataTitle': '中繼資料',
  'screenSpec.pageTitle': '頁面標題',
  'screenSpec.screenId': '畫面 ID',
  'screenSpec.screenName': '畫面名稱',
  'screenSpec.screenPath': '畫面路徑',
  'screenSpec.overview': '概觀',
  'screenSpec.addLevel': '新增層級',
  'screenSpec.deleteLevelAria': '刪除層級 {no}',
  'screenSpec.companyName': '公司',
  'screenSpec.author': '作者',
  'screenSpec.date': '日期',
 'screenSpec.version': '版本',
  ...
  'development.logs': '執行記錄',
  'development.logsEmpty': '尚無執行記錄。',
  'gitChanges.title': '變更',
  'gitChanges.description': '檢視工作區與已暫存的 Git 差異',
  ...
  'gitChanges.refresh': '重新整理',
  'gitChanges.working': '工作區',
  'gitChanges.staged': '已暫存',
  'gitChanges.files': '已變更檔案',
  'gitChanges.noRepository': '目前的工作資料夾不是 Git 儲存庫。',
  'gitChanges.noChanges': '此檢視中沒有變更。',
  'gitChanges.openFile': '開啟檔案',
  'gitChanges.patch': 'Git 差異',
  'gitChanges.viewMode': '差異檢視',
  'gitChanges.splitView': '並排',
  'gitChanges.unifiedView': '統一',
  'gitChanges.before': '變更前',
  'gitChanges.after': '變更後',
  'gitChanges.binary': '二進位檔案無法以文字預覽。',
  'gitChanges.truncated': '較大的差異已截斷顯示。',
  'gitChanges.emptyPatch': '沒有可顯示的差異內容。',
  'gitChanges.loadFailed': '無法載入 Git 變更。',
};
