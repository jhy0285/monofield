...
export const zhTW: Dict = {
  ...
  'pluginsHome.subtitle': '精選 Open Docs 範本，用於快速開始規格文件、簡報、文件與原型。選擇一個即可載入起始提示詞，也可以開啟完整範本庫。',
  'pluginsHome.browseRegistry': '查看全部範本',
  'pluginsHome.count': '{total} 個中的 {filtered} 個',
  'pluginsHome.loadingCatalog': '正在載入範本…',
  'pluginsHome.emptyCatalog': '目前沒有可用範本。Open Docs 內建範本應會自動顯示在這裡；如果問題持續，請重新啟動 daemon。',
  ...
  'designFiles.usefulInfoTip5': '沒有想法？試試首頁「範本圖庫」裡的範本。',
