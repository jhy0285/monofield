...
export const fa: Dict = {
  ...
  'chat.amrCard.switchTitle': 'فراخوانی مدل ناموفق بود',
  'chat.amrCard.switchBody': 'ابتدا دوباره تلاش کنید. اگر مشکل ادامه داشت، آن را در GitHub گزارش کنید.',
  'chat.amrCard.chipOfficial': 'باز کردن Issue در GitHub',
  'chat.amrCard.chipNoKey': 'گزارش یک مشکل',
  'chat.amrCard.chipAutoRetry': 'ابتدا تلاش مجدد',
  'chat.amrCard.switchCta': 'باز کردن Issue در GitHub',
  ...
  'chat.runError.signInMessage.amr': 'عامل MonoField هنوز وارد نشده است — برای استفاده وارد شوید.',
  'chat.runError.signInMessage.other': '{agent} وارد نشده است. وضعیت ورود را به‌صورت محلی بررسی کنید. عامل MonoField را توصیه می‌کنیم — پایدارتر و مقرون‌به‌صرفه‌تر.',
  ...
  'plugins.actions.openHomepage': 'منبع اصلی',
  ...
  'settings.welcomeTitle': 'به MonoField خوش آمدید',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'شروع با یک شرح',
  'settings.onboardingCreateBody': 'سایت، اپلیکیشن، ارائه، تصویر یا ویدیویی را که می‌خواهید توصیف کنید. MonoField یک پروژه می‌سازد و کار را قابل ویرایش نگه می‌دارد.',
  ...
  'settings.onboardingMemoryCalloutBody': 'این پاسخ‌ها نمایهٔ حافظهٔ شما را شکل می‌دهند. MonoField در هر کار از آن استفاده می‌کند و همزمان با کار شما به یادگیری ادامه می‌دهد.',
  ...
  'settings.onboardingGateTooltipAmr': 'مراحل بعدی با هوش مصنوعی اجرا می‌شوند — برای ادامه وارد MonoField AMR شوید.',
  ...
  'settings.agentInstall.stepAuth': 'قبل از بازگشت به MonoField، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'MonoField را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'settings.aboutDescriptor': 'کد / طراحی / اسناد',
  ...
  'settings.mcpHint': 'به Agentهای کدنویسی (Cursor، Claude Code، VS Code…) اجازه دهید پروژه‌های MonoField شما را مستقیماً بخوانند.',
  'settings.mcpDaemonError': 'امکان دسترسی به daemon محلی برای تعیین مسیرهای نصب وجود نداشت ({error}). مطمئن شوید که MonoField در حال اجراست، سپس این پنل را دوباره باز کنید.',
  'settings.mcpBuildDaemon': 'ابتدا daemon را بسازید.',
  'settings.mcpNodeMissing': 'باینری Node یافت نشد.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js یافت نشد. دستور `pnpm build:daemon` را اجرا کنید و صفحه را تازه‌سازی کنید.',
  ...
  'settings.mcpCapabilityDefault': 'به‌صورت پیش‌فرض از پروژه و فایلی که در MonoField باز کرده‌اید استفاده می‌کند، بنابراین می‌توانید بگویید «این را در اپ من بساز» بدون اینکه دوباره مشخص کنید کدام طراحی.',
  'settings.mcpRunningNote': 'برای موفقیت فراخوانی‌های ابزار MCP، MonoField باید در حال اجرا باشد. اگر Agent کدنویسی خود را پیش از باز کردن MonoField راه‌اندازی کرده‌اید، Agent را راه‌اندازی مجدد کنید تا بتواند به daemon زنده دسترسی پیدا کند.',
  ...
  'homeHero.subtitlePrefix': 'کد / طراحی / اسناد',
  ...
  'homeHero.chip.screenSpec': 'مشخصات صفحه',
  ...
  'homeHero.chip.createPluginHint': 'یک افزونه قابل استفاده مجدد MonoField بسازید و آن را به افزونه‌های من اضافه کنید.',
  ...
  'homeHero.chip.screenSpecDesc': 'مستندات صفحه و مشخصات PPTX',
  ...
  'homeHero.chip.screenSpecNext': 'یک پروژه مشخصات صفحه با اسکرین‌شات، نشانگرها، Description و Check Point باز می‌کند.',
  ...
  'handoff.promptIntro': 'ادامه از این پوشه محلی پروژه MonoField:',
  ...
  'pluginsHome.title': 'گالری قالب‌ها',
  'pluginsHome.subtitle': 'قالب‌های منتخب MonoField برای شروع سریع مشخصات، ارائه‌ها، اسناد و نمونه‌های اولیه. یکی را انتخاب کنید تا پرامپت شروع بارگذاری شود، یا کتابخانه کامل قالب‌ها را باز کنید.',
  'pluginsHome.browseRegistry': 'مشاهده همه قالب‌ها',
  'pluginsHome.count': '{filtered} از {total}',
  'pluginsHome.loadingCatalog': 'در حال بارگذاری قالب‌ها…',
  'pluginsHome.emptyCatalog': 'هنوز قالبی در دسترس نیست. قالب‌های همراه MonoField باید به‌صورت خودکار اینجا نمایش داده شوند — اگر مشکل ادامه داشت daemon را دوباره راه‌اندازی کنید.',
  'pluginsHome.emptyFiltered': 'هیچ قالبی با فیلترهای فعلی مطابقت ندارد.',
  'pluginsHome.clearFilters': 'پاک کردن فیلترها',
  'pluginsHome.modeAria': 'حالت گالری قالب‌ها',
  'pluginsHome.featured': 'ذخیره شد',
  'pluginsHome.totalInCatalog': '{n} قالب',
  ...
  'pluginsHome.searchPlaceholder': 'جستجوی قالب‌ها…',
  'pluginsHome.searchAria': 'جستجوی قالب‌ها',
  ...
  'pluginCard.contributeAria': 'مشارکت {title} در MonoField',
  'pluginCard.contributeTitle': 'مشارکت افزونه در MonoField با یک PR',
  ...
  'integrations.lede': 'سیستم‌های خارجی را متصل کنید، ابزارهای MCP را به حلقه Agent خود بیاورید و از MonoField در سایر IDEها، اسکریپت‌ها و خودکارسازی‌ها استفاده کنید.',
  ...
  'mcpClient.daemonError': 'دسترسی به daemon محلی ممکن نشد. مطمئن شوید MonoField در حال اجراست، سپس این پنل را دوباره باز کنید.',
  'mcpClient.saveFailed': 'ذخیره ناموفق بود. بررسی کنید که daemon در حال اجرا باشد و دوباره تلاش کنید.',
  'useEverywhere.modalAria': 'استفاده از MonoField در همه‌جا',
  'useEverywhere.modalTitle': 'استفاده از MonoField در همه‌جا',
  'useEverywhere.modalSubtitle': 'MonoField را در هر IDE، Agent یا اسکریپتی بگنجانید — CLI، HTTP، MCP و Skills. از «Copy guide for an agent» استفاده کنید و آن را در Claude Code، Codex، Cursor، openclaw یا hermes جای‌گذاری کنید تا همه‌چیز راه‌اندازی شود.',
  ...
  'useEverywhere.section.overview.heading': 'MonoField هر جا که Agent شما کار کند، کار می‌کند',
  'useEverywhere.section.overview.intro': 'MonoField چیزی فراتر از یک پنجره است — یک daemon محلیِ دارای دسترسی ویژه (`monofield`) به‌علاوه یک رجیستری از Skills + Design-Systems + Atoms است. به‌محض اینکه روی دستگاه شما در حال اجرا باشد، هر code agent (Claude Code، Codex، Cursor، OpenCode/openclaw، Hermes، یا اسکریپت خودتان) می‌تواند تولیدها را هدایت کند، پروژه‌ها را بررسی کند و از طریق چهار سطح قابل‌تعویض، آثار طراحی تولید کند.',
  'useEverywhere.section.overview.bullet1': 'CLI — `monofield <command>` برای اسکریپت‌های headless، CI و اتوماسیون shell.',
  'useEverywhere.section.overview.bullet2': 'سرور MCP — MonoField را به‌عنوان یک سرور Model Context Protocol سیم‌کشی می‌کند تا هر Agent سازگار با MCP بتواند skillها را فهرست کند، سناریوها را اجرا کند و آثار را بخواند.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — بسته‌های آمادهٔ `SKILL.md` (سازگار با Claude) که هر Agent موجود در PATH شما می‌تواند بدون نیاز به MonoField اصلاً فراخوانی‌شان کند.',
  ...
  'useEverywhere.section.cli.heading': 'کنترل MonoField از هر shell',
  'useEverywhere.section.cli.intro': 'باینری `monofield` همراه با daemon ارائه می‌شود و همان باینری‌ای است که Claude Code / Codex هنگام اجرای یک تولید از آن استفاده می‌کنند. بیشتر زیرفرمان‌ها کلاینت‌های سبکی هستند که به daemon محلی درخواست POST می‌فرستند، بنابراین چه آن را با `pnpm tools-dev` راه‌اندازی کرده باشید و چه به‌عنوان یک اپلیکیشن بسته‌بندی‌شده، یکسان کار می‌کنند.',
  'useEverywhere.section.cli.bullet1': '`monofield` (بدون آرگومان) — daemon را بوت می‌کند و رابط وب را باز می‌کند.',
  'useEverywhere.section.cli.bullet2': '`monofield media generate ...` — تولید بایت‌های تصویر / ویدیو / صدا از طریق پروتکل یکپارچهٔ رسانه.',
  'useEverywhere.section.cli.bullet3': '`monofield run ...` — شروع یک اجرای پروژه از یک پرامپت + skill.',
  'useEverywhere.section.cli.bullet4': '`monofield plugin install <source>` / `monofield plugin apply <id>` — نصب و اعمال پلاگین‌های جامعه.',
  'useEverywhere.section.cli.bullet5': '`monofield skills list` / `monofield design-systems list` — بررسی آنچه به‌صورت محلی در دسترس است.',
  'useEverywhere.section.cli.bullet6': '`monofield status` / `monofield doctor` — تأیید سلامت daemon و شناسایی CLIهای Agent در PATH شما.',
  ...
  'useEverywhere.section.mcp.heading': 'در معرض قرار دادن MonoField به‌عنوان یک سرور MCP برای هر Agent کدنویسی',
  'useEverywhere.section.mcp.intro': 'MonoField با یک سرور Model Context Protocol (`monofield mcp`) ارائه می‌شود که به هر کلاینت سازگار با MCP — Cursor، Claude Code، Antigravity، VS Code Copilot Chat، openclaw، hermes — اجازه می‌دهد ابزارهای MonoField را کشف کند (فهرست‌کردن skillها، رندر پیش‌نمایش‌ها، تولید رسانه، اجرای پلاگین‌ها) بدون نیاز به اجرای دستی در shell. این daemon برای هر کلاینت اصلی یک قطعهٔ نصب آمادهٔ جای‌گذاری را از طریق `GET /api/mcp/install-info` منتشر می‌کند.',
  'useEverywhere.section.mcp.bullet1': 'انتقال stdio — بدون پورت اضافی، کلاینت مستقیماً `monofield mcp` را اجرا می‌کند.',
  ...
  'useEverywhere.section.mcp.bullet4': '`MONOFIELD_DATA_DIR` را پین می‌کند تا فرایند MCP ایجادشده در همان مکانی بنویسد که daemon از پیش استفاده می‌کند (از EPERM در باندل‌های اپلیکیشن بسته‌بندی‌شده macOS جلوگیری می‌کند).',
  ...
  'useEverywhere.section.mcp.footer': 'در اپلیکیشن MonoField، به Settings ← Integrations بروید تا یک دستور نصب مخصوص کلاینت (Cursor، Claude Code، Antigravity، VS Code) را کپی کنید، به‌جای ویرایش دستی JSON.',
  ...
  'useEverywhere.section.http.footer': 'تایپ‌های خالص TypeScript برای هر درخواست/پاسخ در `packages/contracts` قرار دارند — آن‌ها را در اسکریپت خود import کنید تا بدون سیم‌کشی یک generator، تکمیل خودکار کامل داشته باشید.',
  'useEverywhere.section.skills.tab': 'مهارت‌ها و حالت بدون رابط',
  'useEverywhere.section.skills.heading': 'Skillهای آمادهٔ استفاده برای هر Agent — حتی بدون اجرای MonoField',
  'useEverywhere.section.skills.intro': 'یک Skill دایرکتوری‌ای است با یک `SKILL.md` سازگار با Claude (فرانت‌متر YAML + بدنه). MonoField این فرمت را با namespace به نام `od:` گسترش می‌دهد (`mode`، `preview`، `design_system`، `inputs`، …) تا همان اثر هم درون MonoField و هم توسط یک Agent معمولی مانند Claude Code، Codex، openclaw یا hermes قابل‌استفاده باشد. کشف از یک زنجیرهٔ اولویت پیروی می‌کند تا پروژه‌ها بتوانند skillهای خود را بازنویسی کنند.',
  ...
  'useEverywhere.section.skills.bullet4': 'بدون رابط: یک Agent که `monofield` در PATH آن باشد می‌تواند `monofield skills list` را فراخوانی کند و سپس هر مهارتی را اجرا کند؛ daemon برای جریان‌های فقط‌خواندنی اختیاری است.',
  ...
  'useEverywhere.section.skills.snippet1': 'حداقل SKILL.md (front matter سازگار با Claude + افزوده‌های MonoField)',
  ...
  'entry.helpReportProblem': 'گزارش یک مشکل',
  ...
  'entry.githubStarAria': 'به MonoField در GitHub ستاره بدهید',
  ...
  'newproj.locationDefault': 'پروژه‌های MonoField',
  ...
  'socialShare.openDesignSection': 'اشتراک‌گذاری MonoField',
  'socialShare.openDesignTitle': 'MonoField در GitHub',
  'socialShare.openDesignText': 'MonoField یک فضای کاری متن‌باز برای ساخت، ویرایش، استقرار و تحویل آرتیفکت‌های طراحی است.',
  ...
  'socialShare.projectText': 'ساخته‌شده با MonoField: {title}. آرتیفکت مستقرشده را ببینید و به مخزن ستاره بدهید: {repo}',
  'socialShare.projectCopyText': 'ساخته‌شده با MonoField: {title}\n{url}\nمخزن MonoField: {repo}',
  ...
  'brandEnrichment.body': "MonoField یک استخراج عمیق تر را در پس زمینه اجرا می کند، skills مناسب document style را خودکار اعمال می کند و همین سیستم را درجا به روز می کند. این کار ممکن است 10 تا 20 دقیقه طول بکشد؛ می توانید به کارتان ادامه دهید.",
  ...
  'chat.activeFilePlaceholder': 'از MonoField بخواهید {file} را تغییر دهد...',
  'chat.designArtifactsShowMore': 'نمایش {count} فایل طراحی دیگر',
  'chat.mode.chat.label': 'پرسش',
  'chat.mode.chat.title': 'حالت پرسش',
  'chat.mode.chat.summary': 'برای توضیح، بررسی، برنامه ریزی و توسعه نرم افزار بدون اجبار به گردش کار ساخت سند.',
  'chat.mode.chat.solves': 'برای تغییر کد، build، تست، کار با پایگاه داده یا مرورگر و پرسش درباره اسناد موجود استفاده کنید.',
  ...
  'chat.mode.design.label': 'اسناد',
  'chat.mode.design.title': 'حالت اسناد',
  'chat.mode.design.summary': 'برای ساخت، ویرایش، اعتبارسنجی یا خروجی گرفتن از نتایج مشخص مانند مشخصات، ارائه، صفحه گسترده، پروتوتایپ و اسناد پروژه.',
  'chat.mode.design.solves': 'هر زمان فایل یا خروجی ساخت یافته لازم است، از جمله مشخصات فنی در یک پروژه نرم افزاری، استفاده کنید.',
  ...
  'preview.shareTextDefault': 'قالب MonoField: {title}',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید MonoField در حال اجراست و دوباره تلاش کنید.',
  ...
  'designFiles.usefulInfoTip5': 'ایده‌ای ندارید؟ نمونه‌های آماده را در Open Work ببینید.',
  ...
  'assistant.shareToOpenDocs': 'اشتراک‌گذاری در MonoField',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه MonoField — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه MonoField ارائه می‌شود — نیازی به دانلود نیست.',
  ...
  'settings.projectLocationsDescription': 'پایه‌های کاری اضافه کنید که می‌توانند چند پوشهٔ پروژهٔ MonoField را در خود داشته باشند. پروژه‌های جدید به‌صورت یک پوشه داخل پایهٔ انتخاب‌شده ذخیره می‌شوند.',
  ...
  'settings.customInstructionsHint': 'دستورالعمل‌های ثابتی که MonoField باید در هر گفت‌وگو دنبال کند. حقایق، ترجیحات و زمینهٔ پروژه را به‌عنوان حافظه ذخیره کنید.',
  ...
  'settings.memoryStarterProjectDesc': 'MonoField v0.5 — ویرایشگر طراحی مبتنی بر گفتگو',
  ...
  'updater.availableBody': 'نسخه MonoField {version} در دسترس است. صفحه انتشار را باز کنید و نصب‌کننده مناسب سیستم خود را انتخاب و دانلود کنید.',
  'updater.channelBeta': 'کانال بتا',
  'updater.channelPrerelease': 'کانال پیش‌انتشار',
  'updater.channelPreview': 'کانال پیش‌نمایش',
  'updater.channelStable': 'کانال پایدار',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. MonoField در حال بسته شدن است تا بتوانید به‌روزرسانی را کامل کنید.',
  ...
  'updater.openReleasePage': 'باز کردن صفحه انتشار',
  ...
  'updater.quitButton': 'بستن MonoField',
  'updater.quitFailedBody': 'نصب‌کننده باز است، اما MonoField بسته نشد. پیش از جایگزینی برنامه، MonoField را ببندید.',
  'updater.quitFailedTitle': 'امکان بستن نیست',
  'updater.quitting': 'در حال بستن...',
  'updater.ready': 'به‌روزرسانی آماده است',
  'updater.readyGeneric': 'نسخه جدید آماده است. MonoField بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.readyVersion': 'MonoField {version} آماده است. MonoField بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.upToDate': 'شما هم‌اکنون آخرین نسخه را دارید.',
  'community.checkInTitle': 'تجربه شما با MonoField چطور بوده است؟',
  'community.checkInBody': 'آیا خوب کار می‌کند یا چیزی هست که بخواهید بهترش کنیم؟',
  'community.worksWell': 'خوب کار می‌کند',
  'community.shareFeedback': 'ارسال بازخورد',
  'community.later': 'بستن',
  'community.starTitle': 'به بهبود MonoField ادامه می‌دهیم',
  'community.starBody': 'اگر MonoField برایتان مفید بوده، با دادن ستاره در GitHub از آن حمایت کنید.',
  'community.starAction': 'ستاره دادن به MonoField',
  'community.onboardingBody': 'اگر MonoField به کارتان کمک می‌کند، با دادن ستاره در GitHub از بهبودهای بعدی آن حمایت کنید.',
  ...
  'dsManager.createBody': 'برند، محصول، کد، دارایی‌ها و مراجع طراحی خود را به MonoField بیاموزید.',
  ...
  'settings.customInstructionsDesc': 'دستورالعمل‌های ثابتی که MonoField در هر گفت‌وگو از آن‌ها پیروی می‌کند. این‌ها حافظه ذخیره‌شده نیستند؛ برای واقعیت‌ها، ترجیحات و بافت پروژه از حافظه استفاده کنید.',
  ...
  'onboarding.buildBody': 'MonoField برند شما را به یک سیستم طراحی قابل‌استفاده‌ی مجدد تبدیل می‌کند و هر چیزی را که می‌سازید هماهنگ و وفادار به برند نگه می‌دارد.',
  ...
  'screenSpec.loading': 'در حال بارگذاری مشخصات صفحه…',
  'screenSpec.loadFailed': 'بارگذاری فایل مشخصات صفحه ممکن نشد.',
  'screenSpec.invalidJson': 'این فایل یک JSON معتبر مشخصات صفحه نیست.',
  'screenSpec.reload': 'بارگذاری مجدد',
  'screenSpec.reloadTitle': 'بارگذاری مجدد از دیسک (ویرایش‌های ذخیره‌نشده حذف می‌شوند)',
  'screenSpec.save': 'ذخیره',
  'screenSpec.saveDirty': 'ذخیره تغییرات',
  'screenSpec.saving': 'در حال ذخیره…',
  'screenSpec.saved': 'ذخیره شد',
  'screenSpec.fileChangedOnDisk': 'این فایل هنگام ویرایش شما روی دیسک تغییر کرد.',
  'screenSpec.reloadFromDisk': 'حذف ویرایش‌های من و بارگذاری مجدد',
  'screenSpec.fatalIssues': '{count} مشکل مسدودکننده — قبل از خروجی گرفتن برطرف کنید:',
  'screenSpec.screenFallback': 'صفحه {no}',
  'screenSpec.addScreen': 'افزودن صفحه',
  'screenSpec.deleteScreen': 'حذف صفحه',
  'screenSpec.deleteScreenConfirm': 'این صفحه و همه نشانگرهای آن حذف شود؟',
  'screenSpec.uploadImage': 'بارگذاری تصویر',
  'screenSpec.previewHeight': 'ارتفاع پیش‌نمایش',
  'screenSpec.fitImageRatio': 'تنظیم با نسبت تصویر',
  'screenSpec.imageTypeError': 'فقط تصاویر PNG، JPG، JPEG یا WEBP قابل بارگذاری هستند.',
  'screenSpec.imageReadError': 'خواندن فایل تصویر ممکن نشد.',
  'screenSpec.emptyImageTitle': 'ناحیه بارگذاری تصویر',
  'screenSpec.emptyImageHint': 'یک تصویر بارگذاری کنید، سپس برای افزودن نشانگر روی آن کلیک کنید.',
  'screenSpec.markerAria': 'نشانگر {no}: {label}',
  'screenSpec.defaultCalloutLabel': 'مورد {no}',
  'screenSpec.descriptionTitle': 'Description',
  'screenSpec.colLabel': 'برچسب',
  'screenSpec.colDescription': 'Description',
  'screenSpec.emptyCallouts': 'برای افزودن اولین نشانگر روی تصویر کلیک کنید.',
  'screenSpec.labelAria': 'برچسب نشانگر {no}',
  'screenSpec.descriptionAria': 'توضیحات نشانگر {no}',
  'screenSpec.delete': 'حذف',
  'screenSpec.add': 'افزودن',
  'screenSpec.relationsTitle': 'روابط نشانگرها',
  'screenSpec.relationsHint': 'مثلاً کلیک روی دکمه 1 پنجره بازشوی 2 را باز می‌کند.',
  'screenSpec.addRelation': 'افزودن رابطه',
  'screenSpec.needTwoMarkers': 'برای رسم خط رابطه حداقل دو نشانگر لازم است.',
  'screenSpec.emptyRelations': 'برای اتصال نشانگرها با خط قرمز، «افزودن رابطه» را بزنید.',
  'screenSpec.relationFrom': 'از',
  'screenSpec.relationTo': 'به',
  'screenSpec.lineMode': 'سبک خط',
  'screenSpec.lineStraight': 'مستقیم',
  'screenSpec.lineOrthogonal': 'متعامد',
  'screenSpec.relationLabel': 'برچسب',
  'screenSpec.relationLabelPlaceholder': 'مثلاً با کلیک، پنجره بازشو باز می‌شود',
  'screenSpec.markerSize': 'اندازه نشانگر',
  'screenSpec.lineWidth': 'ضخامت خط',
  'screenSpec.checkpointTitle': 'Check Point',
  'screenSpec.checkpointAria': 'نقطه بررسی {no}',
  'screenSpec.newCheckpointPlaceholder': 'یک نقطه بررسی وارد کنید',
  'screenSpec.metadataTitle': 'فراداده',
  'screenSpec.pageTitle': 'عنوان صفحه',
  'screenSpec.screenId': 'شناسه صفحه',
  'screenSpec.screenName': 'نام صفحه',
  'screenSpec.screenPath': 'مسیر صفحه',
  'screenSpec.overview': 'نمای کلی',
  'screenSpec.addLevel': 'افزودن سطح',
  'screenSpec.deleteLevelAria': 'حذف سطح {no}',
  'screenSpec.companyName': 'شرکت',
  'screenSpec.author': 'نویسنده',
  'screenSpec.date': 'تاریخ',
 'screenSpec.version': 'نسخه',
  ...
  'development.logs': 'گزارش‌های اجرا',
  'development.logsEmpty': 'هنوز گزارش اجرایی وجود ندارد.',
  'gitChanges.title': 'تغییرات',
  'gitChanges.description': 'تفاوت‌های Git در درخت کاری و مرحله‌بندی‌شده را بررسی کنید',
  ...
  'gitChanges.refresh': 'تازه‌سازی',
  'gitChanges.working': 'درخت کاری',
  'gitChanges.staged': 'مرحله‌بندی‌شده',
  'gitChanges.files': 'فایل‌های تغییرکرده',
  'gitChanges.noRepository': 'این پوشه کاری مخزن Git نیست.',
  'gitChanges.noChanges': 'در این نما تغییری وجود ندارد.',
  'gitChanges.openFile': 'باز کردن فایل',
  'gitChanges.patch': 'تفاوت Git',
  'gitChanges.viewMode': 'نمای تفاوت',
  'gitChanges.splitView': 'کنار هم',
  'gitChanges.unifiedView': 'یکپارچه',
  'gitChanges.before': 'قبل',
  'gitChanges.after': 'بعد',
  'gitChanges.binary': 'فایل‌های دودویی را نمی‌توان به‌صورت متن پیش‌نمایش کرد.',
  'gitChanges.truncated': 'این تفاوت بزرگ برای نمایش کوتاه شده است.',
  'gitChanges.emptyPatch': 'محتوای تفاوتی موجود نیست.',
  'gitChanges.loadFailed': 'بارگیری تغییرات Git ممکن نشد.',
};
