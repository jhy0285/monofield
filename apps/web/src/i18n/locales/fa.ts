...
export const fa: Dict = {
  ...
  'chat.amrCard.switchBody': 'به سرویس رسمی مدل AMR از MonoField سوئیچ کنید — بدون نیاز به تنظیم کلید API. پس از ورود، اعطای دسترسی و شارژ، این اجرا به‌طور خودکار دوباره انجام می‌شود.',
  ...
  'designFiles.usefulInfoTip7': 'از MonoField راضی هستید؟ در GitHub به ما ستاره بدهید.',
  ...
  'updater.availableBody': 'MonoField {version} موجود است. پیش از باز شدن نصب‌کننده دانلود می‌شود.',
