...
export const fa: Dict = {
  ...
  'homeHero.title': 'امروز روی چه کارِ سندی کار کنیم؟',
  ...
  'pluginsHome.subtitle': 'قالب‌های منتخب Open Docs برای شروع سریع مشخصات، ارائه‌ها، اسناد و نمونه‌های اولیه. یکی را انتخاب کنید تا پرامپت شروع بارگذاری شود، یا کتابخانه کامل قالب‌ها را باز کنید.',
  ...
  'pluginsHome.emptyCatalog': 'هنوز قالبی در دسترس نیست. قالب‌های همراه Open Docs باید به‌صورت خودکار اینجا نمایش داده شوند — اگر مشکل ادامه داشت daemon را دوباره راه‌اندازی کنید.',
  ...
  'designFiles.usefulInfoTip5': 'ایده‌ای ندارید؟ یک قالب را از گالری قالب‌ها در صفحهٔ اصلی امتحان کنید.',
