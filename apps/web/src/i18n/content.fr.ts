...
export const FR_SKILL_COPY: Record<string, { description?: string; examplePrompt?: string }> = {
  ...
  'agent-browser': {
    examplePrompt:
      'Vérifiez la preview locale MonoField avec agent-browser : démarrez ou connectez Chrome CDP, ouvrez http://127.0.0.1:17573/, puis rapportez le titre, l’URL, le texte visible et enregistrez un screenshot.',
    description:
      'Automatisation navigateur pour valider la preview locale MonoField. Se connecte à un endpoint Chrome CDP vérifié, lit l’état rendu de la page, peut cliquer/saisir si nécessaire et enregistre un screenshot.',
  },
  'blog-post': {
    examplePrompt:
  ...
  'open-design-landing': {
    examplePrompt:
      'Concevez la landing page marketing MonoField dans le style Atelier Zero / Monocle — canvas papier chaud, collage surréaliste plâtre + architecture, grande typographie display serif italique mixée, chiffres romains comme marqueurs de sections et un seul accent corail.',
  },
