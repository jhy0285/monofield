...
A small community plugin for exercising the MonoField import UI. It is meant
...
MonoField should install the plugin as a user/community plugin, preserve the
