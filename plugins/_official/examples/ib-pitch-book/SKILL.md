...
repackaged as an MonoField `deck` skill.
...
Follow MonoField's deck export path for the active session (HTML / PDF /
PPTX per daemon capabilities).

## Relationship to MonoField financial skills
...
original adaptation for MonoField.
