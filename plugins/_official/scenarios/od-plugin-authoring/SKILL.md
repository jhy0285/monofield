...
- Treat `SKILL.md` as the canonical behavior description. `open-design.json` should describe how MonoField installs, applies, and presents that behavior.
...
- Include a short readiness summary when finished:
  ...
  - A direct next-action prompt that offers: Add to My plugins, Publish repo, or MonoField PR.
