...
description: Use this plugin when the user wants to create, improve, validate, publish, or submit an MonoField plugin using the plugin spec, examples, and PR workflow.
license: MIT
metadata:
