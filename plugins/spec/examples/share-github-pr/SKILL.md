...
description: Use this plugin when the user wants to package an accepted plugin or artifact as a GitHub pull request for MonoField or another target repository.
license: MIT
metadata:
