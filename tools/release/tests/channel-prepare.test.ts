  ...
  return {
    ...
    platforms: {
      mac: {
        arch: "arm64",
        artifacts: {
          dmg: artifact("MonoField.dmg"),
          zip: artifact("MonoField-mac-arm64.zip"),
        },
        enabled: true,
        signed: true,
      },
      macIntel: {
        arch: "x64",
        artifacts: {
          dmg: artifact("MonoField Intel.dmg"),
          zip: artifact("MonoField-mac-x64.zip"),
        },
        enabled: true,
        signed: true,
      },
      win: {
        arch: "x64",
        artifacts: {
          installer: artifact("MonoField Setup.exe"),
        },
        enabled: true,
      },
    },
