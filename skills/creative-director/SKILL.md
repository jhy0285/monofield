...
## MonoField orchestration mode

When this skill is invoked inside MonoField, treat it as the design-flow
...
3. Search across every available MonoField resource, not only this skill:
